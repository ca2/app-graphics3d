...
#include "direct2d_directx12/geometry.h"
...
namespace draw2d_direct2d_directx12
{
      ...
      m_pgpucontext->_send([this, size]()
         {
            ...
            /*::direct2d_directx12::direct2d_directx12() = allocateø ::draw2d_direct2d_directx12::plugin();
            ...
            auto pdevicecontextDefault = pdirect2d_directx12->default_d2d1_device_context(pwindow, rectanglePlacement);
   ...
   bool graphics::_draw_blend(const ::image::image_drawing & imagedrawing)
   {
      ...
      //      ::pointer<::draw2d_direct2d_directx12::graphics>pgraphicsDib1 = pimage1->get_graphics();

      //      ::pointer<::draw2d_direct2d_directx12::graphics>pgraphicsDib2 = pimage2->get_graphics();
   ...
   void graphics::set(::draw2d::bitmap * pbitmapParam)
   {
      ...
      ::pointer<::draw2d_direct2d_directx12::bitmap>pbitmap = pbitmapParam;
      ...
      //{
         ...
         //::pointer<::draw2d_direct2d_directx12::graphics>pgraphicsMap = m_pgraphicsMap;

         //::pointer<::draw2d_direct2d_directx12::graphics>pgraphics = m_pgraphics;

         //::pointer<::draw2d_direct2d_directx12::bitmap>pbitmap = m_pbitmap;
   ...
   //   auto ppath = __createtø < ::draw2d::path > ();
...
//   }
//
//   void graphics::DrawState(const ::f64_point & point, const ::f64_size& ::f64_size, const ::string & lpszText, unsigned int nFlags, bool bPrefixText, double dTextLen, HBRUSH hBrush)
//   {
//
//      throw ::exception(todo);
//
...
//   }
//
//   void graphics::DrawState(const ::f64_point & point, const ::f64_size& ::f64_size, const ::string & lpszText, unsigned int nFlags, bool bPrefixText, double dTextLen, ::draw2d::brush* pBrush)
//   {
//
//      throw ::exception(todo);
//
...
//
   ...
   void graphics::fill_ellipse(const ::f64_rectangle & rectangle)
   {
      ...
      if (m_pbrush->m_ebrush == ::draw2d::e_brush_box_gradient)
      {
         ...
         //HRESULT hr = ::direct2d_directx12::factory()->CreatePathGeometry(&pgeometry);
   ...
   void graphics::draw_rectangle(const ::f64_rectangle & rectangleParam, ::draw2d::pen * ppen)
   {
      ...
      ::draw2d_direct2d_directx12::pen * ppen2 = dynamic_cast <::draw2d_direct2d_directx12::pen *> (ppen);
   ...
   void graphics::fill_rectangle(const ::f64_rectangle & rectangleParam, ::draw2d::brush * pbrush)
   {
      ...
      ::draw2d_direct2d_directx12::brush * pbrush2 = dynamic_cast <::draw2d_direct2d_directx12::brush *> (pbrush);
   ...
   void graphics::fill_round_rectangle(const ::f64_rectangle & rectangleParam, ::draw2d::brush * pbrush, double dRadius)
   {
      ...
      if (m_pbrush.is_set() && m_pbrush->m_ebrush != ::draw2d::e_brush_null)
      {
         ...
         auto pbrush = m_pbrush.cast <::draw2d_direct2d_directx12::brush >();
   ...
   void graphics::draw_round_rectangle(const ::f64_rectangle & rectangleParam, ::draw2d::pen * ppen, double dRadius)
   {
      ...
      if (m_ppen.is_set() && m_ppen->m_epen != ::draw2d::e_pen_null)
      {
         ...
         auto ppen = m_ppen.cast <::draw2d_direct2d_directx12::pen >();
   ...
   void graphics::_stretch_raw(const ::f64_rectangle & rectangleTarget, ::image::image * pimage, const ::image::image_drawing_options & imagedrawingoptions, const ::f64_rectangle & rectangleSource)
   {
      ...
      //   output_debug_string("direct2d_directx12 graphics::StretchBltRaw hr failed");
   ...
   //   }
      ...
      //void graphics::ExtTextOut(double x, double y, unsigned int nOptions, const ::f64_rectangle & rectangle, const ::string & lpszString, character_count nCount, LPINT lpDxWidths)
      //{
      ...
      //void graphics::ExtTextOut(double x, double y, unsigned int nOptions, const ::f64_rectangle & rectangle, const ::string & str, LPINT lpDxWidths)
      //{
      ...
      //::f64_size graphics::TabbedTextOut(double x, double y, const ::string & lpszString, character_count nCount, ::collection::count nTabPositions, LPINT lpnTabStopPositions, int nTabOrigin)
      //{
      ...
      //::f64_size graphics::TabbedTextOut(double x, double y, const ::string & str, ::collection::count nTabPositions, LPINT lpnTabStopPositions, int nTabOrigin)
      //{
      ...
      //::f64_size graphics::GetTabbedTextExtent(const ::string & lpszString, character_count nCount, ::collection::count nTabPositions, LPINT lpnTabStopPositions)
      //{
      ...
      //::f64_size graphics::GetTabbedTextExtent(const ::string & str, ::collection::count nTabPositions, LPINT lpnTabStopPositions)
      //{
      ...
      //::f64_size graphics::GetOutputTabbedTextExtent(const ::string & lpszString, character_count nCount, ::collection::count nTabPositions, LPINT lpnTabStopPositions)
      //{
      ...
      //::f64_size graphics::GetOutputTabbedTextExtent(const ::string & str, ::collection::count nTabPositions, LPINT lpnTabStopPositions)
      //{
   ...
   void graphics::get_text_metrics(::write_text::text_metric * pmetrics)
   {
      ...
      if (m_pfont.is_null())
      {
         ...
         __constructø(((graphics *)this)->m_pfont);
   ...
   void graphics::fill_path()
   {
      ...
      //return m_prendertarget->FillPath(direct2d_directx12_brush(), m_ppath) == Gdiplus::Status::Ok;
   ...
   void graphics::stroke_and_fill_path()
   {
      ...
      //bool bOk1 = m_prendertarget->FillPath(direct2d_directx12_brush(), m_ppathPaint) == Gdiplus::Status::Ok;

      //bool bOk2 = m_prendertarget->DrawPath(direct2d_directx12_pen(), m_ppathPaint) == Gdiplus::Status::Ok;
   ...
   void graphics::stroke_path()
   {
      ...
      //      return m_prendertarget->DrawPath(direct2d_directx12_pen(), m_ppathPaint) == Gdiplus::Status::Ok;
   ...
   void graphics::widen_path()
   {
      ...
      //      return m_ppath->Widen(direct2d_directx12_pen()) == Gdiplus::Status::Ok;
   ...
   //      //dynamic_cast <::draw2d_direct2d_directx12::graphics *> (pgraphicsSrc)->SaveClip();
   ...
   //         //dynamic_cast <::draw2d_direct2d_directx12::graphics *> (pgraphicsSrc)->RestoreClip();
...
//   {
   ...
   //      auto pregion = __createtø < ::draw2d::region > ();
   ...
   //   ::direct2d_directx12::factory()->CreateRectangleGeometry(r, &pgeometry);
   ...
   //      auto pgeometry = ::direct2d_directx12::geometry::create_ellipse(ellipse);
   ...
   void graphics::intersect_clip(const ::draw2d::clip_group & clipgroup)
   {
      ...
      HRESULT hr = ::direct2d_directx12::factory()->CreatePathGeometry(&ppathgeometry);
   ...
   void graphics::_add_clip_item(ID2D1GeometrySink * pgeometrysink, ::draw2d::clip_item * pclipitem)
   {
      ...
      case ::draw2d::e_clip_item_rectangle:
         ::direct2d_directx12::geometry::add_rectangle(pgeometrysink, dynamic_cast<::draw2d::clip_rectangle *>(pclipitem)->m_item);
         break;
      case ::draw2d::e_clip_item_ellipse:
         ::direct2d_directx12::geometry::add_ellipse(pgeometrysink, dynamic_cast<::draw2d::clip_ellipse *>(pclipitem)->m_item);
         break;
      case ::draw2d::e_clip_item_polygon:
         ::direct2d_directx12::geometry::add_polygon(pgeometrysink, dynamic_cast<::draw2d::clip_polygon *>(pclipitem)->m_item);
         break;
      default:
         break;
      };
   ...
   //      //auto pellipsegeometry = ::direct2d_directx12::geometry::;

   //      auto pgeometry = ::direct2d_directx12::geometry::create_polygon(polygon);
                                           ...
                                           HANDLETABLE * pHandleTable, METARECORD * pMetaRec, double dHandles, LPARAM lParam)
   {
      ...
      case META_SETMAPMODE:
         //(dynamic_cast<::draw2d_direct2d_directx12::graphics * >(pgraphics))->SetMapMode((int)(short)pMetaRec->rdParm[0]);
         break;
      case META_SETWINDOWEXT:
         (dynamic_cast<::draw2d_direct2d_directx12::graphics *>(pgraphics))->set_window_ext(
         (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
         break;
      case META_SETWINDOWORG:
         (dynamic_cast<::draw2d_direct2d_directx12::graphics *>(pgraphics))->SetWindowOrg(
         (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
         break;
      case META_SETVIEWPORTEXT:
         (dynamic_cast<::draw2d_direct2d_directx12::graphics *>(pgraphics))->set_extents(
         (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
         break;
      case META_SETVIEWPORTORG:
         (dynamic_cast<::draw2d_direct2d_directx12::graphics *>(pgraphics))->set_origin(
         (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
         break;
      case META_SCALEWINDOWEXT:
         (dynamic_cast<::draw2d_direct2d_directx12::graphics *>(pgraphics))->scale_window_ext(
         (int)(short)pMetaRec->rdParm[3], (int)(short)pMetaRec->rdParm[2],
         (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
         break;
      case META_SCALEVIEWPORTEXT:
         (dynamic_cast<::draw2d_direct2d_directx12::graphics *>(pgraphics))->scale_extents(
         (int)(short)pMetaRec->rdParm[3], (int)(short)pMetaRec->rdParm[2],
         (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
         break;
      case META_OFFSETVIEWPORTORG:
         (dynamic_cast<::draw2d_direct2d_directx12::graphics *>(pgraphics))->offset_origin(
         (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
         break;
      case META_SAVEDC:
         (dynamic_cast<::draw2d_direct2d_directx12::graphics *>(pgraphics))->save_graphics_context();
         break;
      case META_RESTOREDC:
         (dynamic_cast<::draw2d_direct2d_directx12::graphics *>(pgraphics))->restore_graphics_context((int)(short)pMetaRec->rdParm[0]);
         break;
      case META_SETBKCOLOR:
      {

         auto pbrush = pgraphics->__createtø < ::draw2d::brush >();

         pbrush->create_solid(*(UNALIGNED::color::color *)&pMetaRec->rdParm[0]);

         (dynamic_cast<::draw2d_direct2d_directx12::graphics *>(pgraphics))->set(pbrush);
      ...
      case META_SELECTOBJECT:
      {
         ...
         if (nObjType == 0)
         {
            ...
            //HFONT hFontOld = (HFONT)::SelectObject((dynamic_cast<::draw2d_direct2d_directx12::graphics * >(pgraphics))->get_handle1(), hStockFont);
            //HGDIOBJ hObjOld = ::SelectObject((dynamic_cast<::draw2d_direct2d_directx12::graphics * >(pgraphics))->get_handle1(), hObject);
            //if (hObjOld == hStockFont)
            //{
            //   // got the stock object back, so must be selecting a font
            //   throw ::not_implemented();
            //   //                  (dynamic_cast<::draw2d_direct2d_directx12::graphics * >(pgraphics))->SelectObject(::draw2d_direct2d_directx12::font::from_handle_dup(pgraphics->get_application(), (HFONT)hObject));
            //   break;  // don't play the default record
            //}
            //else
            //{
            //   // didn't get the stock object back, so restore everything
            //   ::SelectObject((dynamic_cast<::draw2d_direct2d_directx12::graphics * >(pgraphics))->get_handle1(), hFontOld);
            //   ::SelectObject((dynamic_cast<::draw2d_direct2d_directx12::graphics * >(pgraphics))->get_handle1(), hObjOld);
            //}
   ...
   //void graphics::draw_text(const ::string & lpszString, character_count nCount, const ::i32_rectangle & rectangle, const ::e_align & ealign, const ::e_draw_text & edrawtext)
   //{
   ...
   void graphics::draw_text(const ::string & str, const ::f64_rectangle & rectangle, const ::e_align & ealign, const ::e_draw_text & edrawtext)
   {
      ...
      if (m_pfont->m_dFontWidth == 1.0)
      {
         ...
         m_prendertarget->DrawText(text.m_wstr, (unsigned int)text.m_wstr.length(), pfont, &float_rectangle, pbrush);
   ...
   //::f64_size graphics::GetOutputTextExtent(const char * lpszString, character_count nCount)
   //{
   ...
   //::f64_size graphics::GetOutputTextExtent(const ::string & str)
   //{
   ...
   //void graphics::get_text_extent(f64_size & size, const char * lpszString, character_count nCount, character_count iIndex)
   f64_size graphics::get_text_extent(const ::scoped_string & scopedstr, character_count iIndex)
   {
      ...
      hr = ::direct2d_directx12::dwrite_factory()->CreateTextLayout(
   ...
   //void graphics::get_text_extent(f64_size & size, const char * lpszString, character_count nCount)
   ...
   void graphics::TextOutRaw(double x, double y, const ::scoped_string & scopedstr)
   {
      ...
      if (lpcwsz != nullptr && uiLen > 0)
      {
         ...
         m_prendertarget->DrawText(lpcwsz, (int)uiLen, pfont, &float_rectangle, pbrush);
   ...
   void graphics::draw_line(double x1, double y1, double x2, double y2, ::draw2d::pen * ppen)
   {
      ...
      m_prendertarget->DrawLine(p1, p2, pbrush, (FLOAT)(dynamic_cast <::draw2d_direct2d_directx12::pen *> (m_ppen.m_p))->m_dWidth);
   ...
   void graphics::line_to(double x, double y)
   {
      ...
      FLOAT fWidth = (FLOAT)(dynamic_cast <::draw2d_direct2d_directx12::pen *> (m_ppen.m_p))->m_dWidth;
   ...
   //                                            );
   //
   //      HRESULT hr = ::direct2d_directx12::factory()->CreateDCRenderTarget(&props,&m_pdcrendertarget);
   //
   //      if (FAILED(hr))
   //      {
   //
   ...
   bool graphics::draw(const ::write_text::text_out & textout, ::draw2d::pen * ppen)
   {
      ...
      //IDWriteFactory * pfactory = ::direct2d_directx12::dwrite_factory();
      ...
      //CustomTextRenderer renderer(::direct2d_directx12::factory(),m_prendertarget,ppen->get_os_data < ID2D1Brush * >(this));
   ...
   bool graphics::fill(const ::write_text::text_out & textout, ::draw2d::brush * pbrush)
   {
      ...
      //   CustomTextRenderer renderer(::direct2d_directx12::factory(), m_prendertarget, nullptr, posbrush);
   ...
   //void graphics::set_direct2d_directx12_plugin(::draw2d_direct2d_directx12::plugin * pplugin)
   //{

   //   ::direct2d_directx12::direct2d_directx12() = pplugin;
   ...
   ID2D1Geometry * graphics::defer_update_os_data(::pointer < ::geometry2d::region > & pregion)
   {
      ...
      ::pointer < region > pdirect2d_directx12region = pregion;

      if (!pdirect2d_directx12region)
      {

         pdirect2d_directx12region = __create_new < region >();

         //pdirect2d_directx12region->m_eregion = pregion->m_eregion;

         pdirect2d_directx12region->m_pitem = pregion->m_pitem;

         pregion = pdirect2d_directx12region;

      }

      return (ID2D1Geometry *)pdirect2d_directx12region->get_os_data(this);
