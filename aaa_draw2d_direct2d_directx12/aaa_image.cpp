...
namespace draw2d_direct2d_directx12
{
   ...
   void image::create_ex(const ::i32_size & size, ::image32_t * pimage32, int iScan, ::enum_flag eflagCreate, int iGoodStride, bool bPreserve)
   {
      ...
      __constructø(pbitmap);
      __constructø(pgraphics);
   ...
   bool image::_create(::draw2d::graphics* pgraphicsParam)
   {
      ...
      ::draw2d::bitmap * pbitmap = dynamic_cast<::draw2d_direct2d_directx12::graphics *>(pgraphicsParam)->get_current_bitmap();
...
//#endif
   ...
   void image::_map(bool bApplyAlphaTransform)
   {
      ...
      auto pgraphics2d = m_pgraphics.cast < ::draw2d_direct2d_directx12::graphics>();
   ...
   void image::blend(const ::i32_point & pointDst, ::image::image * pimageSrc, const ::i32_point & pointSrc, const ::i32_size & sizeParam, unsigned char bA)
   {
      ...
      //   ::draw2d_direct2d_directx12::graphics * pgraphics = dynamic_cast <::draw2d_direct2d_directx12::graphics *> (get_graphics());
      ...
      //      //dynamic_cast <::draw2d_direct2d_directx12::graphics *> (pgraphicsMap)->RestoreClip();
