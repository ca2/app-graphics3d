...
namespace draw2d_direct2d_directx12
{
   ...
   class CLASS_DECL_DRAW2D_DIRECT2D_DIRECTX12 path :
   ...
   public:
      ...
      virtual bool internal_add_string(::draw2d_direct2d_directx12::graphics * pgraphics, double x, double y, const ::string & strText, ::write_text::font * pfont);
