...
//      i32_point MoveTo(int x, int y);
      ...
      //virtual void _fill_rectangle_2025_05_29(const ::f64_rectangle& rectangle, ::draw2d::brush* pBrush);

      //svoid gpu_layer_on_before_end_render() override;
...
//         bool StretchBlt(int x, int y, int nWidth, int nHeight, ::draw2d::graphics * pgraphicsSrc,
  //                    int xSrc, int ySrc, int nSrcWidth, int nSrcHeight);
      ...
      virtual f64_size _get_text_extent(const ::scoped_string& str) override;
