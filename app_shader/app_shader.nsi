...
InstallDirRegKey HKLM "Software\ca2\app-cube\simple_shader" "Install_Dir"
...
Section "BeatMapper (required)"
  ...
  ; Set output path to the installation directory.
  SetOutPath "$INSTDIR\app-cube\appmatter\simple_shader"
  
  ; Put file there
  File /r "C:\ca2\app-cube\appmatter\simple_shader\"
  ...
  File "C:\ca2\time\x64\stage\app_cube.dll"
  ...
  WriteRegStr HKLM "SOFTWARE\ca2\app-cube\simple_shader" "Install_Dir" "$INSTDIR"
...
Section "Uninstall"
  ...
  DeleteRegKey HKLM "SOFTWARE\ca2\app-cube\simple_shader"
