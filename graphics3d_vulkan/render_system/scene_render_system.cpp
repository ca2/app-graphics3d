...
#include "gpu_vulkan/render_target.h"
...
namespace graphics3d_vulkan
{
   ...
   void scene_render_system::on_prepare_2025(::gpu::context *pgpucontext)
   {
...
BEGIN_GPU_PROPERTIES(::graphics3d_vulkan::scene_render_system::push_constants)
