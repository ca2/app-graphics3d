...
//{
//
//   // renderer::renderer(VkWindow& window, ::gpu::context * pgpucontext) : vkcWindow{ window }, m_pgpucontext{ pgpucontext } 
//   renderer::renderer()
//   {
//
//   }
...
//   {
//
//      ::graphics3d::renderer::initialize_renderer(pgpucontext);
//
...
//         }
//         auto result = m_pvkcrenderpass->submitCommandBuffers(&pcommandbuffer->m_vkcommandbuffer, &m_uCurrentSwapChainImage);
