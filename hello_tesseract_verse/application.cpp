...
__IMPLEMENT_APPLICATION_RELEASE_TIME(app_graphics3d_hello_tesseract_verse);
IMPLEMENT_APPLICATION_FACTORY(app_graphics3d_hello_tesseract_verse);
...
namespace app_graphics3d_hello_tesseract_verse
{
   ...
   application::application()
   {
      ...
      m_strAppId = "app-graphics3d/hello_tesseract_verse";

      m_strAppName = "app-graphics3d/hello_tesseract_verse";

      m_strBaseSupportId = "app_graphics3d_hello_tesseract_verse";
   ...
   void application::init_instance()
   {
      ...
      factory()->add_factory_item <::app_graphics3d_hello_tesseract_verse::document >();
      factory()->add_factory_item <::app_graphics3d_hello_tesseract_verse::main_frame >();
      factory()->add_factory_item <::app_graphics3d_hello_tesseract_verse::impact >();
      factory()->add_factory_item <::app_graphics3d_hello_tesseract_verse::pane_impact >();
   ...
   void application::create_options_body(const ::atom & atom, ::user::interaction* pparent)
   {
      ...
      auto pstillTitle = create_label<::user::still>(pparent, "graphics3d hello_tesseract_verse Options");
