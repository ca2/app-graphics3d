// From mnk_controller from V0idsEmbrace@Twich hello_tesseract_verse project
...
//
//   //   ::cast<::app_graphics3d_hello_tesseract_verse::immersion> pimmersion = m_pengine->m_pimmersionlayer;
//
//
//   //               if (pimmersion->m_emouse == ::app_graphics3d_hello_tesseract_verse::e_mouse_updateLook)
//   //   {
//
...
//
//      ::cast<::app_graphics3d_hello_tesseract_verse::camera> pcamera = pgpucamera;
//
//      if (pcamera)
//      {
//
...
//      
//      ::cast<::app_graphics3d_hello_tesseract_verse::immersion> pimmersion = m_pengine->m_pimmersionlayer;
//      if (pimmersion->m_ekeyboard == ::app_graphics3d_hello_tesseract_verse::e_keyboard_updateMovement)
//      {
//
//         process_keyboard_input_updateMovement();
//      }
//      else if (pimmersion->m_ekeyboard == ::app_graphics3d_hello_tesseract_verse::e_keyboard_spaceExplorer)
//      {
//
//         ::cast<::app_graphics3d_hello_tesseract_verse::immersion> pimmersion = m_pengine->m_pimmersionlayer;
