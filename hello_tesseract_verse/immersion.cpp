...
namespace app_graphics3d_hello_tesseract_verse
{
   ...
   immersion::immersion()
   {
      ...
      m_emouse = ::app_graphics3d_hello_tesseract_verse::e_mouse_updateLook;
      m_ekeyboard = ::app_graphics3d_hello_tesseract_verse::e_keyboard_updateMovement;
   ...
   ::pointer<::graphics3d::scene_base> immersion::create_main_scene()
   {
      ...
      auto pinput = create_newø < ::app_graphics3d_hello_tesseract_verse::input>();
   ...
   void immersion::on_pre_update_camera()
   {
      ...
      if (pcameraScene)
      {
         ...
         ::cast<::app_graphics3d_hello_tesseract_verse::camera> pcamera = pcameraScene;
...
} // app_graphics3d_hello_tesseract_verse
