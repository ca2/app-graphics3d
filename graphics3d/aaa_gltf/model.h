...
namespace gpu
{
   ...
   namespace gltf
   {
      ...
      public:
         ...
         virtual void initialize_gpu_gltf_model(::gpu::context * pgpucontext,  const ::file::path & path, bool flipTexturesVertically);
         ...
         virtual void loadModel(const ::file::path & path, bool flipTexturesVertically);
