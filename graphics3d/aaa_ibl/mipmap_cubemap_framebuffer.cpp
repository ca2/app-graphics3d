...
namespace gpu
{
   ...
   namespace ibl
   {
      ...
      void mipmap_cubemap_framebuffer::initialize_mipmap_cubemap_framebuffer(unsigned int width, unsigned int height)
      ...
      void mipmap_cubemap_framebuffer::setMipLevel(unsigned int level)
      {
         ...
         m_ptexture->m_sizeMip.cx =
            (unsigned int)((double) m_ptexture->rectangle().width() *
               ::pow((double)0.5, (double) m_ptexture->m_mipLevels));
         m_ptexture->m_sizeMip.cy =
            (unsigned int)((double) m_ptexture->rectangle().height() *
               ::pow((double)0.5, (double) m_ptexture->m_mipLevels));
         //
