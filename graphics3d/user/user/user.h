...
namespace bred
{
   ...
   class CLASS_DECL_BRED user : virtual public ::berg::user
   //,
   ...
   public:
      ...
      //
      //      virtual pointer< ::sequence < ::conversation > > dialog_box(::particle * pparticle, const
      //      ::scoped_string & scopedstrMatter, ::property_set & propertyset);
      //
      //
      ...
      //      scopedstrTitle = nullptr, const ::user::e_message_box & emessagebox = ::user::e_message_box_ok);
      //      virtual pointer< ::sequence < ::conversation > > ui_message_box_timeout(::particle * pparticle,
      //      ::user::interaction_base * puiOwner, const ::scoped_string & scopedstrMessage, const ::scoped_string &
      //      scopedstrTitle = nullptr, const class time & timeTimeout = ::time::infinity(), const
      //      ::user::e_message_box & emessagebox = ::user::e_message_box_ok);
      //      //virtual void ui_message_box_timeout(::object* pparticle, ::user::interaction_base* puiOwner,
      //      ::payload payload, class ::time timeTimeout, unsigned int fuStyle = ::user::e_message_box_ok,
      //      ::aura::application* papp = nullptr, const function_arg& functionargResult = function_arg());
      //
      //      virtual void on_file_manager_open(::filemanager::data* pdata, ::file::item_array& itema);
      //
      //      int track_popup_menu(const ::scoped_string & scopedstrMatter, const ::int_point & point,
      ...
      //
      //
      //      //virtual bool do_prompt_file_name(::payload& payloadFile, const ::scoped_string & scopedstrTitle,
      //      unsigned int lFlags, bool bOpenFileDialog, ::user::impact_system* ptemplate, ::user::document*
      //      pdocument, const atom & atomFileManager = "file_manager_save");
      //
      //
      ...
      //      scopedstrMatter2);
      //      ////virtual string directory()->matter(const ::scoped_string & scopedstrMatter, const ::scoped_string &
      //      scopedstrMatter2);
      //
      ...
      //
      //
      //      //virtual void locale_schema_matter(string_array_base & stra, const string_array_base &
      //      straMatterLocator, const ::scoped_string & scopedstrLocale, const ::scoped_string & scopedstrSchema)
      //      override;
      ...
      //      scopedstrAppId);
      //
      //      //virtual ::pointer<::user::menu_interaction>create_menu_button(::user::style_pointer & pstyle,
      //      ::menu::item * pitem) override;
      //
      ...
      //
      //      //virtual ::account::user * get_user(::file::path pathUrl = nullptr, bool bFetch = false, bool
      //      bInteractive = true);
      //
      ...
      //
      //      //virtual bool get_auth(const ::scoped_string & scopedstrForm, string & strUsername, string &
      //      strPassword);
      //
      ...
      //      ////virtual void on_request(::request * prequest) override;
      //
      //      //::aura::application * application_get(const ::scoped_string & scopedstrAppId, bool bCreate, bool
      //      bSynch, ::request * prequest) override;
      //
      ...
      //
      //      //virtual void get_cursor_position(::int_point * ppoint);
      //      //inline ::int_point get_cursor_position() {::int_point point; get_cursor_position(&point); return
      //      point;}
      //
      ...
      //
      //      //virtual ::collection::index initial_frame_position(::int_rectangle * prectangle, const
      //      ::int_rectangle & rectangle, bool bMove, ::user::interaction * pinteraction);
      //
      //      //virtual ::collection::index _get_best_zoneing(edisplay * pedisplay, ::int_rectangle * prectangle,
      //      const ::int_rectangle & rectangle, bool bPreserveSize = false);
      //
      ...
      //      rectangle, ::user::interaction* pinteraction, edisplay edisplayRestore);
      //
      //      //virtual ::collection::index get_good_move(::int_rectangle * prectangle, const ::int_rectangle &
      //      rectangle, ::user::interaction * pinteraction);
      //
      ...
      //      ::pointer<::user::interaction>userinteractionParent, ::payload payload =
      //      ::payload(::e_type_empty_argument), ::payload varArgs = ::payload(::e_type_empty_argument));
      //      //::pointer<::user::document>  create_form(::pointer<::user::form>impact, ::user::form_callback*
      //      pcallback, ::pointer<::user::interaction>serinteractionParent, ::payload payload =
      //      ::payload(::e_type_empty_argument), ::payload varArgs = ::payload(::e_type_empty_argument));
      //      //::pointer<::user::document>  create_child_form(::user::form_callback* pcallback,
      //      ::pointer<::user::interaction>userinteractionParent, ::payload payload =
      //      ::payload(::e_type_empty_argument), ::payload varArgs = ::payload(::e_type_empty_argument));
      //      //template < typename VIEW >
      ...
      //
      //      //virtual ::user::interaction* get_request_parent_ui(::user::interaction* pinteraction, ::create*
      //      pcreate);
      //
      ...
      //
      //
      //      //virtual void set_app_title(const ::scoped_string & scopedstrAppId, const ::scoped_string &
      //      scopedstrTitle);
      //
      ...
      //
      //      ////virtual bool open_by_file_extension(const ::scoped_string & scopedstrPathName, ::create* pcreate =
      //      nullptr) override;
      ...
      //
      //      ////virtual ::user::menu_interaction * create_menu_button(::user::style_pointer & pstyle, ::menu::item
      //      * pitem) override;
      //
      ...
      //
      //
      //      //virtual void SendMessageToWindows(::user::enum_message eusermessage, ::wparam wparam, ::lparam
      //      lparam);
      //
      //      virtual void term() override;
      //
