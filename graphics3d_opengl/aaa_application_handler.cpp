...
namespace graphics3d_opengl 
{
   ...
   //   popenglexample->initialize_application(pcontainer);
   ...
   void application_handler::run_application()
   {
      ...
      //::pointer < opengl_land_continuum::application> papp = m_p3dapplication;
      ...
      ////m_pcontext = __allocate context(m_popengldevice);
