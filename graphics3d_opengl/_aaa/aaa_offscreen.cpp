...
//      submitInfo.pWaitDstStageMask = waitStages;
   ...
   void offscreen_render_pass::createRenderPassImpl()
   {
      ...
      VkBool32 validDepthFormat = ::graphics3d_opengl::tools::getSupportedDepthFormat(m_pcontext->physicalDevice, &fbDepthFormat);
...
//	// Find a suitable depth format
//	VkFormat fbDepthFormat;
//	VkBool32 validDepthFormat = ::graphics3d_opengl::tools::getSupportedDepthFormat(physicalDevice, &fbDepthFormat);
//	assert(validDepthFormat);
//
//	// Color attachment
