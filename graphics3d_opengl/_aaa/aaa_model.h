...
//      //   {
//      //      Vertex vertex;
//      //      floating_sequence3 vector; // we declare a placeholder vector since assimp uses its own vector class that doesn't directly convert to glm's vec3 class so we transfer the data to this placeholder floating_sequence3 first.
//      //      // positions
...
//      //      }
//      //      else
//      //         vertex.TexCoords = floating_sequence2(0.0f, 0.0f);
//
