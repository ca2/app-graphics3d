...
//      auto strVert = file()->as_string(m_pgpucontext->m_pimpact->m_pengine->_translate_shader_path(m_pathVert));
//      auto strFrag = file()->as_string(m_pgpucontext->m_pimpact->m_pengine->_translate_shader_path(m_pathFrag));
//
