...
namespace draw2d_gdiplus
{
   ...
   public:
      ...
      ::Gdiplus::GraphicsPath *     m_pathPaint;
      HDC                           m_hdc;
      HDC                           m_hdcAttach;
      HDC                           m_hdcGraphics;
...
//      ::windowing::window * GetWindow() override;
      ...
      virtual unsigned int SetBoundsRect(const ::f64_rectangle & rectangleBounds, unsigned int flags);
      virtual unsigned int GetBoundsRect(::f64_rectangle * rectdBounds, unsigned int flags);
...
//#endif
      ...
      // Viewport Origin
      //virtual i32_point SetViewportOrg(double x, double y) override;
      //virtual i32_point SetViewportOrg(const ::i32_point & point) override;
      //virtual i32_point OffsetViewportOrg(int nWidth, int nHeight) override;

      // Viewport Extent
      virtual f64_size GetViewportExt() override;
      virtual f64_size SetViewportExt(double cx, double cy) override;
      virtual f64_size SetViewportExt(const ::f64_size & size) override;
      //virtual i32_size ScaleViewportExt(int xNum, int xDenom, int yNum, int yDenom) override;
      ...
      virtual f64_size set_window_ext(double cx, double cy) override;
      virtual f64_size set_window_ext(const ::f64_size & size) override;
      virtual f64_size scale_window_ext(double xNum, double xDenom, double yNum, double yDenom) override;
      ...
      // Clipping Functions
      virtual int get_clip_box(::f64_rectangle * prectangle) override;
      ...
      virtual void intersect_clip(const ::f64_polygon& int_polygon);
...
//      i32_point move_to(double x, double y) override;
      ...
      virtual bool poly_polyline(const ::f64_point * ppoint, const int * lpPolyPoints, ::collection::count nCount) override;
      ...
      //bool DrawState(const ::i32_point & point, const ::i32_size & size, HICON hIcon, UINT nFlags,
      //               ::draw2d::brush* pBrush = nullptr) override;
      //bool DrawState(const ::i32_point & point, const ::i32_size & size, const ::string & pszText, UINT nFlags,
      ...
      virtual bool round_rectangle(const ::f64_rectangle & rectangle, double dRadius) override;
      ...
      virtual bool ExtTextOut(double x, double y, UINT nOptions, const f64_rectangle &  prectangle, const ::string & pszString,character_count nCount, LPINT lpDxWidths) override;

      virtual bool ExtTextOut(double x, double y, UINT nOptions, const f64_rectangle &  prectangle, const ::string & str, LPINT lpDxWidths) override;

      virtual f64_size TabbedTextOut(double x, double y, const ::string & pszString, character_count nCount,count nTabPositions, LPINT lpnTabStopPositions, int nTabOrigin) override;

      virtual f64_size TabbedTextOut(double x, double y, const ::string & str,count nTabPositions, LPINT pnTabStopPositions, int nTabOrigin) override;
      ...
      virtual bool _001DrawText(const ::string & str, f64_rectangle & rectangleParam, const ::e_align & ealign = e_align_top_left, const ::e_draw_text & edrawtext = e_draw_text_none, bool bMeasure = false) override;
      ...
      //virtual bool draw_text_ex(const ::string & pszString,character_count nCount,const ::f64_rectangle & rectangle, const ::e_align & ealign = e_align_top_left, const ::e_draw_text & edrawtext = e_draw_text_none,LPDRAWTEXTPARAMS lpDTParams) override;

      virtual bool draw_text_ex(const ::string & str,const ::f64_rectangle & rectangle, const ::e_align & ealign = e_align_top_left, const ::e_draw_text & edrawtext = e_draw_text_none) override;
      ...
      virtual f64_size get_text_extent(const ::string & pszString, character_count nCount, character_count iIndex) override;

      virtual f64_size GetTextBegin(const ::string & pszString, character_count nCount, character_count iIndex) override;

      //virtual f64_size get_text_extent(const ::string & pszString, character_count nCount) override;

      virtual f64_size get_text_extent(const ::string & str) override;
      virtual bool get_text_extent(f64_size & size, const ::string & pszString, character_count nCount, character_count iIndex) override;

      virtual bool get_text_extent(f64_size & size, const ::string & pszString, character_count nCount) override;

      virtual bool get_text_extent(f64_size & size, const ::string & str) override;
      virtual f64_size GetOutputTextExtent(const ::string & pszString, character_count nCount) override;

      virtual f64_size GetOutputTextExtent(const ::string & str) override;
      virtual f64_size GetTabbedTextExtent(const ::string & pszString, character_count nCount,count nTabPositions, LPINT lpnTabStopPositions) override;

      virtual f64_size GetTabbedTextExtent(const ::string & str,count nTabPositions, LPINT pnTabStopPositions) override;

      virtual f64_size GetOutputTabbedTextExtent(const ::string & pszString, character_count nCount,count nTabPositions, LPINT lpnTabStopPositions) override;

      virtual f64_size GetOutputTabbedTextExtent(const ::string & str,count nTabPositions, LPINT pnTabStopPositions) override;
...
//
//      int Escape(int nEscape, int nInputSize,  const char * pszInputData,int nOutputSize, char * pszOutputData) override;
//
//      int DrawEscape(int nEscape, int nInputSize, const ::string & pszInputData) override;
      ...
      int GetPath(::f64_point * ppoint, unsigned char * lpTypes,count nCount) override;
      ...
      virtual bool draw_rectangle(const f64_rectangle& f64_rectangle, const ::color::color& color, const ::e_border & eborder = e_border_all);
...
//      HGDIOBJ set(HGDIOBJ) override;      // do not use for regions
      ...
      //virtual void release_os_data_ex(int i, void *i32_point) override;
...
//      virtual bool attach(void * pdata) override;
      ...
      bool blur(bool bExpand, double dRadius, const ::f64_rectangle & rectangle) override;
