...
namespace draw2d_gdiplus
{
   ...
   bool image::_draw_raw(const ::i32_rectangle & rectangleDstParam, ::image::image * pimageSrc, const ::i32_point & pointSrcParam)
   {
      ...
      else
      {
         ...
         pimageDst->g()->draw(::f64_rectangle(rectangleTarget.top_left(), i32_size ), pimageSrc->g(), pointSrc);
