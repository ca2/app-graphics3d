...
//{
//
//   swap_chain_render_pass::swap_chain_render_pass(::gpu::context * pgpucontextRef, VkExtent2D extent)
//      : render_pass(pgpucontextRef, extent)
//   {
//      init();
//   }
//
//   swap_chain_render_pass::swap_chain_render_pass(::gpu::context * pgpucontextRef, VkExtent2D extent, ::pointer<render_pass> previous)
...
//   }
//
//   HRESULT swap_chain_render_pass::acquireNextImage(uint32_t* imageIndex) {
//      vkWaitForFences(
...
//   }
//
//   HRESULT swap_chain_render_pass::submitCommandBuffers(
...
//      SwapChainSupportDetails m_vkswapchainSupport = m_pgpucontext->getSwapChainSupport();
//
