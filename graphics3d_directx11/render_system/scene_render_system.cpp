...
namespace graphics3d_directx11
{
   ...
   //                                              offsetof(::gpu_directx11::gltf::Vertex, gltf_uv)),
   ...
   //   m_ppipelineOpaque = øcreate_new<::gpu_directx11::pipeline>();
   ...
   //      m_ppipelineMask = øcreate_new<::gpu_directx11::pipeline>();
   ...
   //      m_ppipelineBlend = øcreate_new<::gpu_directx11::pipeline>();
