...
namespace graphics3d_directx11 
{
   ...
   //   pdirectx11example->initialize_application(pcontainer);

   //   pdirectx11example->m_pmousestate = pmousestate;
   //   //pdirectx11example->initDirectX11();

   //   // DirectX11Example->setupWindow(::GetModuleHandleW(L"app_graphics3d_vulken.dll"_ansi), WndProc);
   //   //pdirectx11example->prepare();
   //   //   pdirectx11example->renderLoop20(callback);
   //      //delete(DirectX11Example);
   //   return pdirectx11example;
   //}
   ...
   void application_handler::run_application()
   {
      ...
      //::pointer < directx11_land_continuum::application> papp = m_p3dapplication;
      ...
      ////m_pcontext = __allocate context(m_pdirectx11device);
