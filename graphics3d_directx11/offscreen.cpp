...
//
//
//#define VK_CHECK(x) do { HRESULT err = x; if (err) { std::cerr << "Detected DirectX11 error: " << err << std::endl; abort(); } } while (0)
//
//
...
//      VkBool32 validDepthFormat = ::graphics3d_directx11::tools::getSupportedDepthFormat(m_pgpucontext->physicalDevice, &fbDepthFormat);
