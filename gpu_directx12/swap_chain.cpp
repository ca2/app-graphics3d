...
namespace gpu_directx12
{
   ...
   swap_chain::~swap_chain()
   {
	...
	void swap_chain::init()
	{
		...
		offscreen_render_target_view::init();
...
//		::cast < ::gpu_directx12::device > pgpudevice = m_pgpudevice;
		...
		//
		//HRESULT hrCreatePipeline = pdevice->m_pdevice->CreateGraphicsPipelineState(&psoDesc, __interface_of(m_ppipelinestate));

		//::defer_throw_hresult(hrCreatePipeline);
