...
void context_fbo::on_initialize_particle()
{
   ...
   ::directx12::context::on_initialize_particle();
  ...
  // {
   ...
   void context_fbo::_create_offscreen_buffer(const ::int_size & sizeParam)
   {
      ...
      this->post([this, size]()
         ...
         ::pointer<directx12>pdirectx12 = pgpu;
         
         if (::is_null(pdirectx12))
         {
         ...
         CGLPixelFormatAttribute AttribList[] =
         {
            ...
            //         kCGLPFADirectX12Profile, (CGLPixelFormatAttribute)kCGLOGLPVersion_GL3_Core,
            ...
            //
            //kCGLPFADirectX12Profile, (CGLPixelFormatAttribute)kCGLOGLPVersion_GL4_Core,
            kCGLPFADirectX12Profile, (CGLPixelFormatAttribute)kCGLOGLPVersion_GL3_Core,
            //         kCGLPFADirectX12Profile, (CGLPixelFormatAttribute)kCGLOGLPVersion_GL3_2_Core,
         ...
         //auto displayMask= CGDisplayIDToDirectX12DisplayMask (display);
