...
// #endif
   ...
   void dxgi_debug::debug()
   {
      ...
      ::output_debug_string("directx12::dxgi_debug : IDXGIDebug::ReportLiveObjects");
...
CLASS_DECL_GPU_DIRECTX12 void directx12_debug()
{

   ::directx12::dxgi_debug::s_pdxgidebug->debug();

}
//
//
//
//CLASS_DECL_DIRECT2D void directx12_debug()
//{
//
//   g_pdxgidebug->debug();
//
