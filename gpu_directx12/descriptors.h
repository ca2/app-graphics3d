...
namespace gpu_directx12
{
   ...
   class CLASS_DECL_GPU_DIRECTX12 set_descriptor_layout :
      virtual public ::particle
   {
   public:
      //class CLASS_DECL_GPU_DIRECTX12 Builder
      //{
      //public:
   ...
   class CLASS_DECL_GPU_DIRECTX12 descriptor_pool :
      virtual public ::particle
   {
   public:
...
//      VkDescriptorPool descriptorPool;
   ...
   class CLASS_DECL_GPU_DIRECTX12 descriptor_writer
   {
   public:
