/*
 * directx12 examples debug wrapper
 *
...
//
//
//         // The return value of this callback controls whether the DirectX12 call that caused the validation message will be aborted or not
//         // We return VK_FALSE as we DON'T want DirectX12 calls that cause a validation message to abort
...
//         HRESULT result = vkCreateDebugUtilsMessengerEXT(instance, &debugUtilsMessengerCI, nullptr, &debugUtilsMessenger);
