...
namespace gpu_directx12
{
   ...
   public:
      ...
      //VkQueue                          m_vkqueue;
      //// Depth buffer format (selected during DirectX12 initialization)
...
//      ::array<VkFence>                 m_fencewaita;
      ...
      /** @brief Encapsulated physical and logical directx12 device */
      ...
      ::string m_strTitle = "DirectX12 Example";
      ::string m_strName = "directx12Example";
...
//#endif
      ...
      //__creatable_from_base(directx12, ::gpu::approach);
