...
namespace graphics3d_hello3d
{
   ...
   class CLASS_DECL_APP_COMPLEX_HELLO3D application :
   ...
   public:
      ...
      //::pointer < ::user::single_document_template >     m_ptemplateMain;
      //::pointer < ::user::multiple_document_template >     m_ptemplateImpact;
