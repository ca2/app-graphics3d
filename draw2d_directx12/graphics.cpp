...
//
//CLASS_DECL_AURA void directx12_debug();
//
//#endif
...
namespace draw2d_directx12
{
   ...
   ::gpu_directx12::context* graphics::gpu_context()
   {

      return dynamic_cast <::gpu_directx12::context*>(::gpu::graphics::gpu_context());
   ...
   void graphics::create_for_window_draw2d(::user::interaction * puserinteraction, const ::i32_size& size)
   {
      ...
      //m_pdevicecontext = m_pdirectx12->default_d2d1_device_context(pdxgidevicesource);
   ...
   //void graphics::_create_memory_graphics(const ::i32_size & size)
   {
...

      {
         ...
         //auto pdirectx12 = ::directx12::from_gpu_device(m_pgpucontextCompositor->m_pgpudevice);

         //initialize_directx12_object(pdirectx12);
      ...
      pcontext->send([this, sizeParameter]()
         {
            ...
            ::gpu::context_lock context_lock(pcontext);
            /*::directx12::directx12() = allocateø ::draw2d_directx12::plugin();
            ...
            //auto pdirectx12 = m_pdirectx12;

            ////::directx12_lock lock(pdirectx12);

            //::cast < ::dxgi_device_source > pdxgidevicesource = m_pgpucontextCompositor;

            ////auto pdevicecontextDefault = pdirectx12->default_d2d1_device_context(pdxgidevicesource);
   ...
   void graphics::gpu_layer_on_after_begin_render()
   {
      ...
      ////m_bInLayer = true;
      //
      //m_pdirectx12->m_pd2d1multithread->Enter();
   ...
   void graphics::gpu_layer_on_before_end_render()
   {
      ...
      //m_pdirectx12->m_pd2d1multithread->Leave();
   ...
   bool graphics::_draw_blend(const ::image::image_drawing & imagedrawing)
   {
      ...
      //      ::pointer<::draw2d_directx12::graphics>pgraphicsDib1 = pgraphicsImage1;

      //      ::pointer<::draw2d_directx12::graphics>pgraphicsDib2 = pgraphicsImage2;
   ...
   void graphics::set(::draw2d::bitmap * pbitmapParam)
   {
      ...
      ::pointer<::draw2d_directx12::bitmap>pdraw2dbitmap = pbitmapParam;
      ...
      //{
         ...
         //::pointer<::draw2d_directx12::graphics>pgraphicsMap = m_pgraphicsMap;

         //::pointer<::draw2d_directx12::graphics>pdraw2dgraphics = m_pgraphics;

         //::pointer<::draw2d_directx12::bitmap>pdraw2dbitmap = m_pdraw2dbitmap;
      ...
      //m_pdevicecontext->SetTarget(pdraw2dbitmap->m_pdraw2dbitmap);
   ...
   void graphics::paint_region(::draw2d::region * pregion)
   {
      ...
      warning() << "look! this is a warning! paint_region isn't yet implemented here in draw2d_directx12";
      //throw ::exception(todo);
      //ASSERT(get_handle1() != nullptr);
   ...
   //   pdraw2dpath->add_arc(rectangle, (int) start, (int) fmod(end + 360.0 - start, 360.0));
   ...
   void graphics::arc(double x1, double y1, double w, double h, ::f64_angle start, ::f64_angle extends)
   {

      auto pdraw2dpath = createø < ::draw2d::path >();

      ::i32_rectangle rectangle((int)x1, (int)y1, (int)(x1 + w), (int)(y1 + h));
   ...
   void graphics::arc(double x1, double y1, double x2, double y2, double x3, double y3, double x4, double y4)
   {
      ...
      ::i32_rectangle rectangle((int)x1, (int)y1, (int)x2, (int)y2);
...
//   }
//
//   void graphics::DrawState(const ::f64_point & point, const ::f64_size& ::f64_size, HBITMAP hBitmap, unsigned int nFlags, HBRUSH hBrush)
//   {
//
//      throw ::exception(todo);
//      //ASSERT(get_handle1() != nullptr);
...
//   }
//
//   void graphics::DrawState(const ::f64_point & point, const ::f64_size& ::f64_size, ::draw2d::bitmap* pBitmap, unsigned int nFlags, ::draw2d::brush* pBrush)
//   {
//
//      throw ::exception(todo);
//
...
//   }
//
//   void graphics::DrawState(const ::f64_point & point, const ::f64_size& ::f64_size, HICON hIcon, unsigned int nFlags, HBRUSH hBrush)
//   {
//
//
//      throw ::exception(todo);
...
//
//
//   void graphics::DrawState(const ::f64_point & point, const ::f64_size& ::f64_size, HICON hIcon, unsigned int nFlags, ::draw2d::brush* pBrush)
//   {
//
//
//      throw ::exception(todo);
...
//   }
//
//   void graphics::DrawState(const ::f64_point & point, const ::f64_size& ::f64_size, const ::scoped_string & scopedstrText, unsigned int nFlags, bool bPrefixText, double dTextLen, HBRUSH hBrush)
//   {
//
//      throw ::exception(todo);
//
...
//   }
//
//   void graphics::DrawState(const ::f64_point & point, const ::f64_size& ::f64_size, const ::scoped_string & scopedstrText, unsigned int nFlags, bool bPrefixText, double dTextLen, ::draw2d::brush* pBrush)
//   {
//
//      throw ::exception(todo);
//
...
//
//   /*
//   void graphics::DrawState(const ::f64_point & point, const ::f64_size& ::f64_size, DRAWSTATEPROC lpDrawProc, LPARAM lData, unsigned int nFlags, HBRUSH hBrush)
//   {
//
//      throw ::exception(todo);
//
...
//   }
//
//   void graphics::DrawState(const ::f64_point & point, const ::f64_size& ::f64_size, DRAWSTATEPROC lpDrawProc, LPARAM lData, unsigned int nFlags, ::draw2d::brush* pBrush)
//   {
//
//      throw ::exception(todo);
//
...
//
//
   //void graphics::DrawEdge(::f64_rectangle * prectangle, unsigned int nEdge, unsigned int nFlags)
   //{
   ...
   //void graphics::DrawFrameControl(::f64_rectangle * prectangle, unsigned int nType, unsigned int nState)
   //{
   ...
   void graphics::fill_ellipse(const ::f64_rectangle & rectangle)
   {
      ...
      if (m_pdraw2dbrush->m_ebrush == ::draw2d::e_brush_box_gradient)
      {
         ...
         //HRESULT hr = m_pdirectx12->d2d1_factory1()->CreatePathGeometry(&pgeometry);
      ...
      //m_pdevicecontext->FillEllipse(&ellipse, pdraw2dbrush);
   ...
   void graphics::draw_ellipse(const ::f64_rectangle & rectangle)
   {
      ...
      //m_pdevicecontext->DrawEllipse(&ellipse, pdraw2dbrush, (FLOAT)m_pdraw2dpen->m_dWidth);
   ...
   void graphics::draw_rectangle(const ::f64_rectangle & rectangleParam, ::draw2d::pen * pdraw2dpen)
   {
      ...
      ::gpu::graphics::draw_rectangle(rectangleParam, pdraw2dpen);
      ...
      ////::draw2d_directx12::pen * ppen2 = dynamic_cast <::draw2d_directx12::pen *> (pdraw2dpen);
   ...
   //};
   //   ::comptr<ID3D12Resource> CreateRectangleVertexBuffer(
   //      ID3D12Device* device,
   ...
   void graphics::fill_rectangle(const ::f64_rectangle & rectangleParam, ::draw2d::brush * pdraw2dbrush)
   {
      ...
      ::color::color color = pdraw2dbrush->m_color;
      ...
      //::draw2d_directx12::brush * pbrush2 = dynamic_cast <::draw2d_directx12::brush *> (pdraw2dbrush);
   ...
   void graphics::fill_round_rectangle(const ::f64_rectangle & rectangleParam, ::draw2d::brush * pdraw2dbrush, double dRadius)
   {
      ...
      if (m_pdraw2dbrush.is_set() && m_pdraw2dbrush->m_ebrush != ::draw2d::e_brush_null)
      {
         ...
         //auto pdraw2dbrush = m_pdraw2dbrush.cast <::draw2d_directx12::brush >();
   ...
   void graphics::draw_round_rectangle(const ::f64_rectangle & rectangleParam, ::draw2d::pen * pdraw2dpen, double dRadius)
   {
      ...
      if (m_pdraw2dpen.is_set() && m_pdraw2dpen->m_epen != ::draw2d::e_pen_null)
      {
         ...
         auto pdraw2dpen = m_pdraw2dpen.cast <::draw2d_directx12::pen >();
   ...
   void graphics::_stretch_raw(const ::f64_rectangle & rectangleTarget, ::image::image * pimage, const ::image::image_drawing_options & imagedrawingoptions, const ::f64_rectangle & rectangleSource)
   {
...

      {
         ...
         //::directx12_lock directx12lock(::directx12::from_gpu_device(m_pgpucontextCompositor->m_pgpudevice));
      ...
      //   output_debug_string("directx12 graphics::StretchBltRaw hr failed");
   ...
   //   }
      ...
      //void graphics::ExtTextOut(double x, double y, unsigned int nOptions, const ::f64_rectangle & rectangle, const ::scoped_string & scopedstrString, character_count nCount, LPINT lpDxWidths)
      //{
      ...
      //void graphics::ExtTextOut(double x, double y, unsigned int nOptions, const ::f64_rectangle & rectangle, const ::scoped_string & scopedstr, LPINT lpDxWidths)
      //{
      ...
      //::f64_size graphics::TabbedTextOut(double x, double y, const ::scoped_string & scopedstrString, character_count nCount, ::collection::count nTabPositions, LPINT lpnTabStopPositions, int nTabOrigin)
      //{
      ...
      //::f64_size graphics::TabbedTextOut(double x, double y, const ::scoped_string & scopedstr, ::collection::count nTabPositions, LPINT lpnTabStopPositions, int nTabOrigin)
      //{
   ...
   void graphics::get_text_metrics(::write_text::text_metric * pmetrics)
   {
      ...
      ::gpu::graphics::get_text_metrics(pmetrics);
   ...
   //   }
   //
   //   void graphics::ScrollDC(int dx, int dy, const ::i32_rectangle & rectangleScroll, const ::i32_rectangle & rectangleClip, ::draw2d::region* pRgnUpdate, ::i32_rectangle * lpRectUpdate)
   //   {
   //
   //      throw ::exception(todo);
   //
   ...
   unsigned int graphics::GetBoundsRect(::f64_rectangle * prectBounds, unsigned int flags)
   {
   ...
   //
   //
   //   void graphics::PlgBlt(::f64_point * lpPoint, ::draw2d::graphics * pgraphicsSrc, double xSrc, double ySrc, double dWidth, double dHeight, ::draw2d::bitmap& maskBitmap, double xMask, double yMask)
   //   {
   //
   //      throw ::exception(todo);
   //
   ...
   void graphics::poly_polyline(const ::f64_point * ppoints, const int * lpPolyPoints, ::collection::count nCount)
   {
   ...
   void graphics::fill_path()
   {
      ...
      //return m_pd2d1rendertarget->FillPath(directx12_brush(), m_ppath) == Gdiplus::Status::Ok;
   ...
   //int graphics::GetPath(::f64_point * ppoints, unsigned char * lpTypes, ::collection::count nCount)
   //{
   ...
   void graphics::stroke_and_fill_path()
   {
      ...
      //bool bOk1 = m_pd2d1rendertarget->FillPath(directx12_brush(), m_ppathPaint) == Gdiplus::Status::Ok;

      //bool bOk2 = m_pd2d1rendertarget->DrawPath(directx12_pen(), m_ppathPaint) == Gdiplus::Status::Ok;
   ...
   void graphics::stroke_path()
   {
      ...
      //      return m_pd2d1rendertarget->DrawPath(directx12_pen(), m_ppathPaint) == Gdiplus::Status::Ok;
   ...
   void graphics::widen_path()
   {
      ...
      //      return m_ppath->Widen(directx12_pen()) == Gdiplus::Status::Ok;
   ...
   //void graphics::_alpha_blend_raw(const ::f64_rectangle & rectangleTarget, ::draw2d::graphics * pgraphicsSrc, const ::f64_rectangle & rectangleSource, double dRate)
   //{
   ...
   //      //dynamic_cast <::draw2d_directx12::graphics *> (pgraphicsSrc)->SaveClip();
   ...
   //         //dynamic_cast <::draw2d_directx12::graphics *> (pgraphicsSrc)->RestoreClip();
...
//   {
   ...
   //f64_point graphics::offset_origin(double dWidth, double dHeight)
   //{
   ...
   f64_point graphics::offset_window_org(double dWidth, double dHeight)
   {
   ...
   //   m_pdirectx12->d2d1_factory1()->CreateRectangleGeometry(r, &pgeometry);
   ...
   //      auto pgeometry = ::directx12::geometry::create_ellipse(ellipse);
   ...
   void graphics::intersect_clip(const ::draw2d::clip_group& clipgroup)
   {
      ...
      //HRESULT hr = m_pdirectx12->d2d1_factory1()->CreatePathGeometry(&ppathgeometry);
   ...
   //      ::directx12::geometry::add_rectangle(pgeometrysink, dynamic_cast<::draw2d::clip_rectangle *>(pclipitem)->m_item);
   //      break;
   //   case ::draw2d::e_clip_item_ellipse:
   //      ::directx12::geometry::add_ellipse(pgeometrysink, dynamic_cast<::draw2d::clip_ellipse *>(pclipitem)->m_item);
   //      break;
   //   case ::draw2d::e_clip_item_polygon:
   //      ::directx12::geometry::add_polygon(pgeometrysink, dynamic_cast<::draw2d::clip_polygon *>(pclipitem)->m_item);
   //      break;
   //   default:
   //      break;
   //   };
   ...
   //      //auto pellipsegeometry = ::directx12::geometry::;

   //      auto pgeometry = ::directx12::geometry::create_polygon(polygon);
   ...
   //int graphics::OffsetClipRgn(const ::f64_size& ::f64_size)
   //{
...
//         m_pdirectx12->m_pd2d1multithread->Leave();
   ...
   void graphics::polydraw(const ::f64_point * ppoints, const unsigned char * lpTypes, ::collection::count nCount)
   {
...
//         //(dynamic_cast<::draw2d_directx12::graphics * >(pdraw2dgraphics))->SetMapMode((int)(short)pMetaRec->rdParm[0]);
//         break;
//      case META_SETWINDOWEXT:
//         (dynamic_cast<::draw2d_directx12::graphics *>(pdraw2dgraphics))->set_window_ext(
//         (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
//         break;
//      case META_SETWINDOWORG:
//         (dynamic_cast<::draw2d_directx12::graphics *>(pdraw2dgraphics))->SetWindowOrg(
//         (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
//         break;
//      case META_SETVIEWPORTEXT:
//         (dynamic_cast<::draw2d_directx12::graphics *>(pdraw2dgraphics))->set_extents(
//         (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
//         break;
//      case META_SETVIEWPORTORG:
//         (dynamic_cast<::draw2d_directx12::graphics *>(pdraw2dgraphics))->set_origin(
//         (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
//         break;
//      case META_SCALEWINDOWEXT:
//         (dynamic_cast<::draw2d_directx12::graphics *>(pdraw2dgraphics))->scale_window_ext(
//         (int)(short)pMetaRec->rdParm[3], (int)(short)pMetaRec->rdParm[2],
//         (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
//         break;
//      case META_SCALEVIEWPORTEXT:
//         (dynamic_cast<::draw2d_directx12::graphics *>(pdraw2dgraphics))->scale_extents(
//         (int)(short)pMetaRec->rdParm[3], (int)(short)pMetaRec->rdParm[2],
//         (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
//         break;
//      case META_OFFSETVIEWPORTORG:
//         (dynamic_cast<::draw2d_directx12::graphics *>(pdraw2dgraphics))->offset_origin(
//         (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
//         break;
//      case META_SAVEDC:
//         (dynamic_cast<::draw2d_directx12::graphics *>(pdraw2dgraphics))->save_graphics_context();
//         break;
//      case META_RESTOREDC:
//         (dynamic_cast<::draw2d_directx12::graphics *>(pdraw2dgraphics))->restore_graphics_context((int)(short)pMetaRec->rdParm[0]);
//         break;
...
//
//         (dynamic_cast<::draw2d_directx12::graphics *>(pdraw2dgraphics))->set(pdraw2dbrush);
//
//      }
//      break;
...
//            //HFONT hFontOld = (HFONT)::SelectObject((dynamic_cast<::draw2d_directx12::graphics * >(pdraw2dgraphics))->get_handle1(), hStockFont);
//            //HGDIOBJ hObjOld = ::SelectObject((dynamic_cast<::draw2d_directx12::graphics * >(pdraw2dgraphics))->get_handle1(), hObject);
//            //if (hObjOld == hStockFont)
//            //{
//            //   // got the stock object back, so must be selecting a font
//            //   throw ::not_implemented();
//            //   //                  (dynamic_cast<::draw2d_directx12::graphics * >(pdraw2dgraphics))->SelectObject(::draw2d_directx12::font::from_handle_dup(pdraw2dgraphics->get_application(), (HFONT)hObject));
//            //   break;  // don't play the default record
//            //}
//            //else
//            //{
//            //   // didn't get the stock object back, so restore everything
//            //   ::SelectObject((dynamic_cast<::draw2d_directx12::graphics * >(pdraw2dgraphics))->get_handle1(), hFontOld);
//            //   ::SelectObject((dynamic_cast<::draw2d_directx12::graphics * >(pdraw2dgraphics))->get_handle1(), hObjOld);
//            //}
...
//#endif
   ...
   void graphics::draw_text(const ::scoped_string & scopedstr, const ::f64_rectangle & rectangle, const ::e_align & ealign, const ::e_draw_text & edrawtext)
   {
      ...
      ////auto & text = m_pwritetextfont->m_mapFontText[str];
      ...
      ////   m_pd2d1rendertarget->DrawText(text.m_wstr, (unsigned int)text.m_wstr.length(), pwritetextfont, &float_rectangle, pdraw2dbrush);
   ...
   //::f64_size graphics::GetOutputTextExtent(const_char_pointer lpszString, character_count nCount)
   //{
   ...
   //void graphics::get_text_extent(f64_size & size, const_char_pointer lpszString, character_count nCount, character_count iIndex)
   f64_size graphics::get_text_extent(const ::scoped_string & scopedstr, character_count iIndex)
   {
      ...
      ////hr = m_pdirectx12->dwrite_factory()->CreateTextLayout(
      ...
      ////size.cx = (double)(m.widthIncludingTrailingWhitespace * m_pwritetextfont->m_dFontWidth);
   ...
   //void graphics::get_text_extent(f64_size & size, const_char_pointer lpszString, character_count nCount)
   ...
   void graphics::fill_rectangle(const ::f64_rectangle & rectangleParam, const ::color::color & color)
   {
      ...
      ::gpu::graphics::fill_rectangle(rectangleParam, color);
...
//      //m_pdevicecontext->FillRectangle(&rectangle, psolidbrush);
   ...
   void graphics::TextOutRaw(double x, double y, const ::scoped_string & scopedstr)
   {
      ...
      ::gpu::graphics::TextOutRaw(x, y, scopedstr);
      ...
      ////   m_pd2d1rendertarget->DrawText(lpcwsz, (int)uiLen, pwritetextfont, &float_rectangle, pdraw2dbrush);
   ...
   void graphics::line(double x1, double y1, double x2, double y2)
   {
      ...
      //m_pd2d1rendertarget->DrawLine(p1, p2, pdraw2dbrush, (FLOAT)(dynamic_cast <::draw2d_directx12::pen *> (m_pdraw2dpen.m_p))->m_dWidth);
   ...
   void graphics::line(double x1, double y1, double x2, double y2, ::draw2d::pen* pdraw2dpen)
   {
      ...
      //FLOAT fWidth = (FLOAT)(dynamic_cast <::draw2d_directx12::pen *> (m_pdraw2dpen.m_p))->m_dWidth;
   ...
   void graphics::set_alpha_mode(::draw2d::enum_alpha_mode ealphamode)
   {
      ...
      if (m_ealphamode != ealphamode)
      {
         ...
         //      ::cast < ::gpu_directx12::device > pgpudevice = pcontext->m_pgpudevice;

         //      HRESULT hr = pgpudevice->m_pd3d12device->CreateBlendState(
         //         &blendDesc,
...
//      ::cast < ::dxgi_device_source > pdxgidevicesource = m_pgpucontextCompositor;
//
//      auto pd2d1device = m_pdirectx12->d2d1_device(pdxgidevicesource);
//
//      /*ID2D1Device* d2dDevice = nullptr;
//      m_pdirectx12->d2d1_factory1()->CreateDevice(pdxgidevice, &d2dDevice);*/
//
...
//   }
   ...
   //                                            );
   //
   //      HRESULT hr = m_pdirectx12->d2d1_factory1()->CreateDCRenderTarget(&props,&m_pdcrendertarget);
   //
   //      if (FAILED(hr))
   //      {
   //
   ...
   //      double radius = pdraw2dbrush->m_dRadius;
   ...
   //   m_pdevicecontext1->DrawGeometryRealization(prealization, pdraw2dbrush);
   ...
   void graphics::draw(::draw2d::path * ppathParam, ::draw2d::pen * pdraw2dpen)
   {
      ...
      ::gpu::graphics::draw(ppathParam, pdraw2dpen);
      ...
      //ID2D1PathGeometry * pgeometry = pdraw2dpath->get_os_data < ID2D1PathGeometry * >(this, path_hollow);
      ...
      //      auto prealization = pdraw2dpath->_get_stroked_geometry_realization(this, (int)pdraw2dpen->m_dWidth);
   ...
   bool graphics::draw(const ::write_text::text_out & textout, ::draw2d::pen * pdraw2dpen)
   {
      ...
      //CustomTextRenderer renderer(m_pdirectx12->d2d1_factory1(),m_pd2d1rendertarget,pdraw2dpen->get_os_data < ID2D1Brush * >(this));
   ...
   bool graphics::fill(const ::write_text::text_out & textout, ::draw2d::brush * pdraw2dbrush)
   {
      ...
      //   CustomTextRenderer renderer(m_pdirectx12->d2d1_factory1(), m_pd2d1rendertarget, nullptr, posbrush);
...
//#endif
   ...
   //void graphics::set_directx12_plugin(::draw2d_directx12::plugin * pplugin)
   //{

   //   ::directx12::directx12() = pplugin;
   ...
   //   HRESULT hr = m_pd2d1rendertarget->CreateSolidColorBrush(d2d1color, &pdraw2dbrush);
   ...
   //   HRESULT hr = m_pd2d1rendertarget->CreateLinearGradientBrush(&prop, &brushproperties, pstopcollection, &pdraw2dbrush);
   ...
   //   ::pointer < region > pdirectx12region = pregion;

   //   if (!pdirectx12region)
   //   {

   //      pdirectx12region = create_newø < region >();

   //      //pdirectx12region->m_eregion = pregion->m_eregion;

   //      pdirectx12region->m_pitem = pregion->m_pitem;

   //      pregion = pdirectx12region;
