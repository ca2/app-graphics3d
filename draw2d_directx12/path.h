...
namespace draw2d_directx12
{
   ...
   class CLASS_DECL_DRAW2D_DIRECTX12 path :
   ...
   public:
      ...
      //ID2D1GeometryRealization * _get_stroked_geometry_realization(::draw2d::graphics * pdraw2dgraphics, int iWidth);
      ...
      virtual bool internal_add_line(::draw2d::graphics * pdraw2dgraphics, double x, double y);

      virtual bool internal_add_rectangle(::draw2d::graphics * pdraw2dgraphics, double x, double y, double cx, double cy);

      virtual bool internal_add_ellipse(::draw2d::graphics * pdraw2dgraphics, double x, double y, double cx, double cy);
      ...
      virtual bool internal_add_string(::draw2d_directx12::graphics * pdraw2dgraphics, double x, double y, const ::scoped_string & scopedstrText, ::write_text::font * pwritetextfont);

      virtual bool internal_start_figure(::draw2d::graphics * pdraw2dgraphics);

      virtual bool internal_start_figure(::draw2d::graphics * pdraw2dgraphics, double x, double y);
      ...
      //virtual bool _set(::draw2d::graphics * pdraw2dgraphics, ::draw2d::path::int_polygon* pline) override;
