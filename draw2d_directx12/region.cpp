...
namespace draw2d_directx12
{
   ...
   bool region::contains(::draw2d::graphics * pdraw2dgraphics, int x, int y) const
   {
   ...
   //   auto prectanglegeometry = ::directx12::geometry::create_rectangle(m_pdirectx12, pitem->m_item);
   ...
   //   //m_pdirectx12->d2d1_factory1()->CreateEllipseGeometry(ellipse, &pgeometry);

   //   auto pellipsegeometry = ::directx12::geometry::create_ellipse(m_pdirectx12,pitem->m_item);
   ...
   //   auto ppathgeometry = ::directx12::geometry::create_polygon(m_pdirectx12, pitem->m_polygon);
   ...
   //      pdraw2dpath->begin_figure();
   //      pdraw2dpath->add_polygon(ppolygon->data(), (int) ppolygon->size());
   ...
   //   ::pointer < graphics > pdirectx12graphics = pdraw2dgraphics;

   //   auto pgeometry1 = pdirectx12graphics->defer_update_os_data(pitem->m_pregion1);

   //   auto pgeometry2 = pdirectx12graphics->defer_update_os_data(pitem->m_pregion2);
