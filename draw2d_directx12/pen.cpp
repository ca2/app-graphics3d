...
namespace draw2d_directx12
{
   ...
   //   HRESULT hr = m_pdirectx12->d2d1_factory1()->CreateStrokeStyle(&properties1, nullptr, 0, &pstrokestyle);
   ...
   void pen::update(::draw2d::graphics * pdraw2dgraphics)
   {
      ...
      if((!m_bMetroColor || m_colorMetro != m_color) || m_pdraw2dbrush == nullptr)
      {
         ...
         //pdraw2dgraphics->m_pd2d1rendertarget->CreateSolidColorBrush(color, &m_pdraw2dbrush);
         ...
         //m_pstrokestyle = _create_stroke_style(pdraw2dgraphics,
         //   m_elinecapBeg,
         //   m_elinecapEnd);
