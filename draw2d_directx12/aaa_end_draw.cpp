...
#include "directx12/graphics.h"

namespace draw2d_directx12
{


   //class CLASS_DECL_DRAW2D_DIRECTX12 swap_chain_end_draw :
   ...
   void swap_chain_end_draw::initialize_end_draw(::draw2d_gpu::graphics* pgraphics)
   {
      ...
      //m_pd2d1device = pdirectx12->d2d1_device(pwindow, rectanglePlacement);
