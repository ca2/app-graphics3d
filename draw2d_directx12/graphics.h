...
namespace draw2d_directx12
{
   ...
   class CLASS_DECL_DRAW2D_DIRECTX12 graphics :
...
//         D2D1_LAYER_PARAMETERS               m_layerparameters;
      ...
      //::comptr < ID3D12BlendState > m_pblendstateAlphaMode;
      //::comptr < ID3D12BlendState > m_pblendstateSetMode;
      ...
      ::gpu_directx12::context* gpu_context();
...
//      bool DrawState(const ::f64_point & point, const ::f64_size & size, HICON hIcon, unsigned int nFlags,
//                     ::draw2d::brush* pBrush = nullptr) override;
//      bool DrawState(const ::f64_point & point, const ::f64_size & size, const ::scoped_string & scopedstrText, unsigned int nFlags,
...
//                          unsigned int clrTransparent) override;
      ...
      //virtual bool ExtTextOut(double x, double y, unsigned int nOptions, const ::f64_rectangle & rectangle, const ::scoped_string & scopedstrString, character_count nCount, LPINT lpDxWidths) override;
      //virtual bool ExtTextOut(double x, double y, unsigned int nOptions, const ::f64_rectangle & rectangle, const ::scoped_string & scopedstr, LPINT lpDxWidths) override;
      //virtual ::f64_size TabbedTextOut(double x, double y, const ::scoped_string & scopedstrString, character_count nCount, ::collection::count nTabPositions, LPINT lpnTabStopPositions, int nTabOrigin) override;
      //virtual ::f64_size TabbedTextOut(double x, double y, const ::scoped_string & scopedstr, ::collection::count nTabPositions, LPINT lpnTabStopPositions, int nTabOrigin) override;
...
//      virtual int draw_text_ex(char * lpszString, int nCount, ::f64_rectangle * prectangle, const ::e_align & ealign = e_align_top_left, const ::e_draw_text & edrawtext = e_draw_text_none, LPDRAWTEXTPARAMS lpDTParams) override;
      //    virtual int draw_text_ex(const ::scoped_string & scopedstr, ::f64_rectangle * prectangle, const ::e_align & ealign = e_align_top_left, const ::e_draw_text & edrawtext = e_draw_text_none, LPDRAWTEXTPARAMS lpDTParams) override;
...
//      virtual Gdiplus::FillMode directx12_get_fill_mode() override;
...
//      virtual void set_directx12_plugin(::draw2d_directx12::plugin * pplugin);
//#endif
   ...
   class CLASS_DECL_DRAW2D_DIRECTX12 layer
   {
   public:
