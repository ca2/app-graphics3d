...
//#include "draw2d_directx12/_.h"
#include "windowing_win32/_.h"
//#include "draw2d_directx12/swap_chain.h"
...
namespace draw2d_directx12
{
   ...
   class CLASS_DECL_DRAW2D_DIRECTX12 directx12_swap_chain :
      virtual public ::draw2d_directx12::swap_chain,
   ...
   public:
      ...
      //::pointer < ::draw2d_directx12::graphics > m_pgraphics;
      ...
      directx12_swap_chain();
      ~directx12_swap_chain() override;

      void initialize_gpu_swap_chain(::gpu::device* pgpudevice, ::windowing::window* pwindow) override;

      //void initialize_directx12_draw2d_gpu_swap_chain(::gpu::device* pgpudevice, ::windowing::window* pwindow) override;
