...
namespace graphics3d_directx 
{
   ...
   //::pointer<::directx::application > start_directx_application(::::cube::container* pcontainer, mouse_state* pmousestate)
   //{
   //   auto pdirectxexample = pcontainer->__create_new < application_handler >();

   //   pdirectxexample->initialize_application(pcontainer);

   //   pdirectxexample->m_pmousestate = pmousestate;
   //   //pdirectxexample->initDirectX();

   //   // DirectXExample->setupWindow(::GetModuleHandleW(L"app_graphics3d_vulken.dll"_ansi), WndProc);
   //   //pdirectxexample->prepare();
   //   //   pdirectxexample->renderLoop20(callback);
   //      //delete(DirectXExample);
   //   return pdirectxexample;
   //}
   ...
   void application_handler::run_application()
   {
      ...
      //::pointer < directx_land_continuum::application> papp = m_p3dapplication;
      ...
      ////m_pcontext = __allocate context(m_pdirectxdevice);
