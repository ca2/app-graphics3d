...
//   //context::context(::graphics3d_directx::DirectXDevice* pdevice) : m_vkdevice{pdevice->logicalDevice} {
//   context::context()
//   {
//
...
//      appInfo.pApplicationName = "LittleDirectXEngine App";
...
//      if (deviceCount == 0) {
//         throw ::exception(error_failed, "failed to find GPUs with DirectX support!");
//      }
//      std::cout << "Device count: " << deviceCount << std::endl;
//      ::array<VkPhysicalDevice> devices(deviceCount);
//      vkEnumeratePhysicalDevices(m_vkinstance, &deviceCount, devices.data());
//
//      for (const auto& pgpucontext : devices) {
//         if (isDeviceSuitable(pgpucontext)) {
//            physicalDevice = pgpucontext;
//            break;
//         }
//      }
//
...
//      std::cout << "physical pgpucontext: " << properties.deviceName << std::endl;
//   }
//
//
...
//
//      // might not really be necessary anymore because pgpucontext specific validation layers
...
//         {
//            SwapChainSupportDetails swapChainSupport = querySwapChainSupport(pgpucontext);
...
//
//
//   bool context::checkDeviceExtensionSupport(VkPhysicalDevice pgpucontext)
//   {
//
//      uint32_t extensionCount;
//      vkEnumerateDeviceExtensionProperties(pgpucontext, nullptr, &extensionCount, nullptr);
//
...
//      vkGetPhysicalDeviceQueueFamilyProperties(pgpucontext, &queueFamilyCount, queueFamilies.data());
//
//      int i = 0;
...
//
//
//   SwapChainSupportDetails context::querySwapChainSupport(VkPhysicalDevice pgpucontext)
//   {
//
...
//      {
//
//         vkGetPhysicalDeviceSurfaceCapabilitiesKHR(pgpucontext, m_vksurfacekhr, &details.capabilities);
//
//         uint32_t formatCount;
//         vkGetPhysicalDeviceSurfaceFormatsKHR(pgpucontext, m_vksurfacekhr, &formatCount, nullptr);
//
//         if (formatCount != 0) {
//            details.formats.resize(formatCount);
//            vkGetPhysicalDeviceSurfaceFormatsKHR(pgpucontext, m_vksurfacekhr, &formatCount, details.formats.data());
//         }
//
//         uint32_t presentModeCount;
//         vkGetPhysicalDeviceSurfacePresentModesKHR(pgpucontext, m_vksurfacekhr, &presentModeCount, nullptr);
//
