...
//
//      swap_chain_render_pass(::gpu::context * pgpucontextRef, VkExtent2D windowExtent);
//      swap_chain_render_pass(::gpu::context * pgpucontextRef, VkExtent2D windowExtent, ::pointer <render_pass>previous);
...
//
//      HRESULT acquireNextImage(uint32_t* imageIndex);
