...
#include "context.h"
//#include "directx-cube/graphics3d_directx/base_application_no_swap_chain.h"
...
namespace graphics3d_directx 
{
   ...
   //class DirectXExample20 : public base_application_no_swap_chain
   //{
   //public:
   ...
   //   struct {
   //      ::graphics3d_directx::Buffer vsShared;
   //      ::graphics3d_directx::Buffer vsMirror;
   //      ::graphics3d_directx::Buffer vsOffScreen;
   //   } uniformBuffers;
   ...
   //   virtual void OnUpdateUIOverlay(::graphics3d_directx::UIOverlay* overlay);
   ...
   //};
	...
	class CLASS_DECL_GRAPHICS3D_DIRECTX application_handler :
      public ::cube::application
   {
	public:
		...
		//static constexpr int HEIGHT = 600;
            ...
            // Private Members
      //VkWindow _window{ WIDTH, HEIGHT, "DirectX window" };
