...
//namespace std {
//    template <>
//    struct hash<::graphics3d_directx::model::Vertex> {
//        size_t operator()(::graphics3d_directx::model::Vertex const& vertex) const {
//            size_t seed = 0;
//            ::graphics3d_directx::hash_combine(seed, vertex.position, vertex.color, vertex.normal, vertex.uv);
//            return seed;
//        }
//    };
//}  // namespace std
