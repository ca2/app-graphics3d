...
//
//
//#define VK_CHECK(x) do { HRESULT err = x; if (err) { std::cerr << "Detected DirectX error: " << err << std::endl; abort(); } } while (0)
//
//
...
//      VkBool32 validDepthFormat = ::graphics3d_directx::tools::getSupportedDepthFormat(m_pgpucontext->physicalDevice, &fbDepthFormat);
...
////	// Find a suitable depth format
////	VkFormat fbDepthFormat;
////	VkBool32 validDepthFormat = ::graphics3d_directx::tools::getSupportedDepthFormat(physicalDevice, &fbDepthFormat);
////	assert(validDepthFormat);
////
////	// Color attachment
...
////	////memAlloc.allocationSize = memReqs.size;
////	////memAlloc.memoryTypeIndex = directxDevice->getMemoryType(memReqs.memoryTypeBits, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT);
