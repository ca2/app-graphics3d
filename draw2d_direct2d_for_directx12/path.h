...
//      virtual public ::draw2d::path
   ...
   public:
      ...
      //virtual bool internal_add_string(::draw2d_direct2d_for_directx12::graphics * pdraw2dgraphics, ::f64 x, ::f64 y, const ::scoped_string & scopedstrText, ::write_text::font * pwritetextfont);
