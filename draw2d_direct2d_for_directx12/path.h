...
#include "draw2d_direct2d_for_directx11/path.h"
//#include "object.h"
...
namespace draw2d_direct2d_for_directx12
{
   ...
   class CLASS_DECL_DRAW2D_DIRECT2D_FOR_DIRECTX12 path :
      virtual public ::draw2d_direct2d_for_directx11::path//,
//      virtual public ::draw2d::path
   ...
   public:
      ...
      //ID2D1GeometryRealization * _get_stroked_geometry_realization(::draw2d::graphics * pgraphics, ::i32 iWidth);
      //ID2D1GeometryRealization * _get_filled_geometry_realization(::draw2d::graphics * pgraphics);

      //virtual bool internal_add_arc(::draw2d::graphics * pgraphics, const ::f64_arc & arc);

      //virtual bool internal_add_line(::draw2d::graphics* pgraphics, ::f64 x, ::f64 y);

      //virtual bool internal_add_rectangle(::draw2d::graphics* pgraphics, ::f64 x, ::f64 y, ::f64 cx, ::f64 cy);

      //virtual bool internal_add_ellipse(::draw2d::graphics * pgraphics, ::f64 x, ::f64 y, ::f64 cx, ::f64 cy);

      //virtual bool internal_add_lines(::draw2d::graphics* pgraphics, const ::i32_point_array & pointa, bool bClose);

      //virtual bool internal_add_lines(::draw2d::graphics* pgraphics, const ::f64_point_array& pointa, bool bClose);

      //virtual bool internal_add_string(::draw2d_direct2d_for_directx12::graphics * pgraphics, ::f64 x, ::f64 y, const ::scoped_string & scopedstrText, ::write_text::font * pfont);

      //virtual bool internal_start_figure(::draw2d::graphics * pgraphics);

      //virtual bool internal_start_figure(::draw2d::graphics* pgraphics, ::f64 x, ::f64 y);
      ...
      ////virtual bool _set(::draw2d::graphics* pgraphics, ::draw2d::path::i32_polygon* pline) override;
