...
#include "draw2d_direct2d_for_directx11/draw2d.h"
...
namespace draw2d_direct2d_for_directx12
{
   ...
   class CLASS_DECL_DRAW2D_DIRECT2D_FOR_DIRECTX12 draw2d :
      virtual public ::draw2d_direct2d_for_directx11::draw2d
   {
   public:
