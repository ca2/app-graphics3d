...
namespace draw2d_direct2d_for_directx12
{
   ...
   bool region::contains(::draw2d::graphics * pdraw2dgraphics, ::i32 x, ::i32 y) const
   {
      ...
      //return m_pd2d1geometry->IsVisible(::f32_point)  != false;
   ...
   bool region::RectInRegion(const ::i32_rectangle & rectangle) const
   {
      ...
      //return m_pd2d1geometry->IsVisible(::f32_rectangle)  != false;
      return false;
   ...
   void region::update(::draw2d::graphics * pdraw2dgraphics)
   {
      ...
      //return m_pd2d1geometry != nullptr;
   ...
   //   //m_pd2d1geometry = ::transfer((ID2D1PathGeometry *) pdraw2dpath->detach());
   ...
   void region::destroy()
   {
      ...
      ::draw2d_direct2d_for_directx11::region::destroy();
   //   m_pd2d1geometry = nullptr;
