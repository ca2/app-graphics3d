...
namespace draw2d_direct2d_for_directx12
{
   ...
   graphics::graphics()
   {
      ...
      m_bLayerResourceAcquired = false;
   ...
   //void graphics::create_compatible_graphics(::draw2d::graphics *pdraw2dgraphics) { _create_memory_graphics({256, 256}); }
   ...
   bool graphics::_is_ok() const
   {
      ...
      return ::is_set(this) && m_pd2d1devicecontext.is_set();
   ...
   void graphics::create_for_window_draw2d(::user::interaction *puserinteraction, const ::i32_size &size)
   {
      ...
      ->m_pacmewindowingwindow, this, {}, pointOutput, sizeWindow, sizeRaw);
   ...
   //   ::defer_throw_hresult(m_pd2d1rendertarget.as(m_pd2d1devicecontext));
   ...
   void image::update_as_backed_by_gpu_texture(const ::i32_size & size, ::gpu::texture * pgputexture, ::draw2d::graphics * pdraw2dgraphics)
   {
      ...
      ::cast < ::draw2d_direct2d_for_directx11::bitmap > pdraw2dbitmap = m_pdraw2dbitmap;
      ...
      //if (pdraw2dbitmap->m_pgputexture != pgputexture)
      {

         pdraw2dbitmap->m_pgputexture = pgputexture;

         m_size = pgputexture->m_textureattributes.m_size;

         m_sizeRaw = pgputexture->m_textureattributes.m_sizeRaw;

         pdraw2dbitmap->update_bitmap_as_backed_by_gpu_texture(pgputexture, pdraw2dgraphics);
   ...
   ::draw2d::bitmap * graphics::get_target_bitmap()
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::get_target_bitmap();
      ...
      //::cast<::draw2d_direct2d_for_directx12::bitmap> pdraw2dbitmap = m_pdraw2dbitmapTarget;
      ...
      //pdraw2dbitmap->m_size.cx = size.width;

      //pdraw2dbitmap->m_size.cy = size.height;
   ...
   //      ::gpu::context_lock context_lock(pcontext);
   //      /*::direct2d::direct2d() = allocateø ::draw2d_direct2d_for_directx12::plugin();
   ...
   void graphics::_create_memory_graphics(const ::i32_size & size, ::acme::user::interaction * pacmeuserinteractionAffinity)
   {
      ...
      if (::is_set(m_pacmeuserinteractionAffinity))
      {
         ...
         pacmewindowingwindow = m_pacmeuserinteractionAffinity->acme_windowing_window();
      ...
      pgpucontextNew->create_draw2d_gpu_context(pgpudevice, pacmewindowingwindow, this, {}, {}, size, sizeRaw);
      ...
      pcontext->sendø() << [this, size]()
         {
            ...
            //::cast<::dxgi_device_source > pdxgidevicesource = gpu_context()->m_pgpudevice;
            ...
            //   hr = m_pd2d1bitmaprendertarget->GetBitmap(&pdraw2dbitmap);
            //   if (SUCCEEDED(hr) &&
            ...
            //hr = m_pd2d1bitmaprendertarget.as(m_pd2d1rendertarget);
            ...
            //hr = m_pd2d1bitmaprendertarget.as(m_pd2d1devicecontext);
   ...
   ::f64_point graphics::GetBrushOrg()
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::GetBrushOrg();
   ...
   ::f64_point graphics::SetBrushOrg(::f64 x, ::f64 y)
   {
      ...
      //return ::f64_point();
      return ::draw2d_direct2d_for_directx11::graphics::SetBrushOrg(x, y);
   ...
   ::f64_point graphics::SetBrushOrg(const ::f64_point & point)
   {
      ...
      //return ::f64_point();
      return ::draw2d_direct2d_for_directx11::graphics::SetBrushOrg(point);
   ...
   bool graphics::_draw_blend(const ::image::image_drawing & imagedrawing)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::_draw_blend(imagedrawing);
      ...
      ////      ::pointer<::draw2d_direct2d_for_directx12::graphics>pgraphicsDib1 = pgraphicsImage1;

      ////      ::pointer<::draw2d_direct2d_for_directx12::graphics>pgraphicsDib2 = pgraphicsImage2;
   ...
   bool graphics::TextOutAlphaBlend(::f64 x, ::f64 y, const ::scoped_string & scopedstr)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::TextOutAlphaBlend(x, y, scopedstr);
      ...
      //   ::pointer<::draw2d_direct2d_for_directx12::graphics>pgraphicsDib1 = pgraphicsImage1.get();

      //   ::pointer<::draw2d_direct2d_for_directx12::graphics>pgraphicsDib2 = pgraphicsImage2.get();
   ...
   void graphics::set(::draw2d::bitmap * pbitmapParam)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::set(pbitmapParam);
      ////::draw2d::lock draw2dlock;

      //// ::draw2d::device_lock devicelock(this);

      //::pointer<::draw2d_direct2d_for_directx12::bitmap>pdraw2dbitmap = pbitmapParam;
      ...
      //   //::pointer<::draw2d_direct2d_for_directx12::graphics>pgraphicsMap = m_pgraphicsMap;

      //   //::pointer<::draw2d_direct2d_for_directx12::graphics>pdraw2dgraphics = m_pgraphics;

      //   //::pointer<::draw2d_direct2d_for_directx12::bitmap>pdraw2dbitmap = m_pdraw2dbitmap;
   ...
   void graphics::_get(::geometry2d::matrix & matrix)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::_get(matrix);
   ...
   void graphics::_set(const ::geometry2d::matrix & matrix)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::_set(matrix);
   ...
   ::f64_size graphics::get_extents()
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::get_extents();
...
//
  //    return {};
      return ::draw2d_direct2d_for_directx11::graphics::GetWindowOrg();
   ...
   ::f64_size graphics::GetWindowExt()
   {
      ...
      ////return ::f64_size;
      //return {};
      return ::draw2d_direct2d_for_directx11::graphics::GetWindowExt();
   ...
   ::f64_size graphics::set_extents(const ::f64_size & size)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::set_extents(size);
   ...
   ::f64_point graphics::SetWindowOrg(const ::f64_point & point)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::SetWindowOrg(point);
   ...
   void graphics::DPtoLP(::f64_point * ppoints, ::collection::count nCount)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::DPtoLP(ppoints, nCount);
   ...
   void graphics::DPtoLP(::f64_rectangle * prectangle)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::DPtoLP(prectangle);
      //throw ::exception(todo);
   ...
   void graphics::LPtoDP(::f64_point * ppoints, ::collection::count nCount)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::LPtoDP(ppoints, nCount);
      //throw ::exception(todo);
   ...
   void graphics::LPtoDP(::f64_rectangle * prectangle)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::LPtoDP(prectangle);
      //throw ::exception(todo);
   ...
   void graphics::fill_region(::draw2d::region * pRgn, ::draw2d::brush * pBrush)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::fill_region(pRgn, pBrush);
      //throw ::exception(todo);
   ...
   void graphics::frame_region(::draw2d::region * pRgn, ::draw2d::brush * pBrush, ::f64 nWidth, ::f64 nHeight)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::frame_region(pRgn, pBrush, nWidth, nHeight);
      //throw ::exception(todo);
   ...
   void graphics::invert_region(::draw2d::region * pregion)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::invert_region(pregion);
   ...
   void graphics::paint_region(::draw2d::region * pregion)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::paint_region(pregion);
      //warning() << "look! this is a warning! paint_region isn't yet implemented here in draw2d_direct2d_for_directx12";
      //throw ::exception(todo);
      //ASSERT(get_handle1() != nullptr);
   ...
   ::f64_point graphics::current_position()
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::current_position();
      //throw ::exception(todo);
      ////ASSERT(get_handle2() != nullptr);
      ////::f64_point point;
   ...
   void graphics::arc(::f64 x1, ::f64 y1, ::f64 w, ::f64 h, ::f64_angle start, ::f64_angle extends)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::arc(x1, y1, w, h, start, extends);
   ...
   void graphics::arc(::f64 x1, ::f64 y1, ::f64 x2, ::f64 y2, ::f64 x3, ::f64 y3, ::f64 x4, ::f64 y4)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::arc(x1, y1, x2, y2, x3, y3, x4, y4);
      //auto pdraw2dpath = createø < ::draw2d::path >();
   ...
   void graphics::arc(const ::f64_rectangle & rectangle, const ::f64_point & pointStart, const ::f64_point & pointEnd)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::arc(rectangle, pointStart, pointEnd);
   ...
   void graphics::polyline(const ::f64_point * ppoints, ::collection::count nCount)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::polyline(ppoints, nCount);
      //auto pdraw2dpath = createø < ::draw2d::path >();
   ...
   void graphics::frame_rectangle(const ::f64_rectangle & rectangleParam, ::draw2d::brush * pdraw2dbrush)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::frame_rectangle(rectangleParam, pdraw2dbrush);
      //if (m_pd2d1rendertarget == nullptr)
      //{
      ...
      //m_pd2d1rendertarget->DrawRectangle(rectangle, pdraw2dbrush->get_os_data < ID2D1Brush * >(this));
   ...
   void graphics::invert_rectangle(const ::f64_rectangle & rectangle)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::invert_rectangle(rectangle);
...
//
   ...
   void graphics::Chord(::f64 x1, ::f64 y1, ::f64 x2, ::f64 y2, ::f64 x3, ::f64 y3, ::f64 x4, ::f64 y4)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::Chord(x1, y1, x2, y2, x3, y3, x4, y4);
      //throw ::exception(todo);
   ...
   void graphics::Chord(const ::f64_rectangle & rectangle, const ::f64_point & pointStart, const ::f64_point & pointEnd)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::Chord(rectangle, pointStart, pointEnd);
      //throw ::exception(todo);
   ...
   void graphics::DrawFocusRect(const ::f64_rectangle & rectangle)
   {
      ...
      //throw ::exception(todo);
      ::draw2d_direct2d_for_directx11::graphics::DrawFocusRect(rectangle);
   ...
   void graphics::fill_ellipse(const ::f64_rectangle & rectangle)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::fill_ellipse(rectangle);
      ...
      //auto pdraw2dbrush = m_pdraw2dbrush->get_os_data < ID2D1Brush * >(this);
      ...
      //m_pd2d1devicecontext->FillEllipse(&ellipse, pdraw2dbrush);
   ...
   void graphics::draw_ellipse(const ::f64_rectangle & rectangle)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::draw_ellipse(rectangle);
      ...
      //auto pdraw2dbrush = m_pdraw2dpen->get_os_data < ID2D1Brush * >(this);
      ...
      //m_pd2d1devicecontext->DrawEllipse(&ellipse, pdraw2dbrush, (FLOAT)m_pdraw2dpen->m_dWidth);
   ...
   void graphics::Pie(::f64 x1, ::f64 y1, ::f64 x2, ::f64 y2, ::f64 x3, ::f64 y3, ::f64 x4, ::f64 y4)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::Pie(x1, y1, x2, y2, x3, y3, x4, y4);
      //throw ::exception(todo);
   ...
   void graphics::Pie(const ::f64_rectangle & rectangle, const ::f64_point & pointStart, const ::f64_point & pointEnd)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::Pie(rectangle, pointStart, pointEnd);
      //throw ::exception(todo);
   ...
   void graphics::polygon(const ::f64_point * ppoints, ::collection::count count)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::polygon(ppoints, count);
      //if (count < 3)
      //{
   ...
   void graphics::draw_polygon(const ::f64_point * ppoints, ::collection::count count)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::draw_polygon(ppoints, count);
   ...
   void graphics::fill_polygon(const ::f64_point * ppoints, ::collection::count count)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::fill_polygon(ppoints, count);
   ...
   void graphics::rectangle(const ::f64_rectangle & rectangle)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::rectangle(rectangle);
   ...
   void graphics::draw_rectangle(const ::f64_rectangle & rectangleParam, ::draw2d::pen * pdraw2dpen)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::draw_rectangle(rectangleParam, pdraw2dpen);
      ...
      //::draw2d_direct2d_for_directx12::pen * ppen2 = dynamic_cast <::draw2d_direct2d_for_directx12::pen *> (pdraw2dpen);

      //defer_primitive_blend();

      //m_pd2d1rendertarget->DrawRectangle(&rectangle, ppen2->get_os_data < ID2D1Brush * >(this), (FLOAT)pdraw2dpen->m_dWidth);
   ...
   void graphics::fill_rectangle(const ::f64_rectangle & rectangleParam, ::draw2d::brush * pdraw2dbrush)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::fill_rectangle(rectangleParam, pdraw2dbrush);
      ...
      //::draw2d_direct2d_for_directx12::brush * pbrush2 = dynamic_cast <::draw2d_direct2d_for_directx12::brush *> (pdraw2dbrush);
   ...
   void graphics::fill_round_rectangle(const ::f64_rectangle & rectangleParam, ::draw2d::brush * pdraw2dbrush, ::f64 dRadius)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::fill_round_rectangle(rectangleParam, pdraw2dbrush, dRadius);
      //if (pdraw2dbrush->m_ebrush == ::draw2d::e_brush_box_gradient)
      //{
      ...
      //   auto pdraw2dbrush = m_pdraw2dbrush.cast <::draw2d_direct2d_for_directx12::brush >();

      //   ID2D1Brush * pd2d1brush = pdraw2dbrush->get_os_data < ID2D1Brush * >(this);
   ...
   void graphics::draw_round_rectangle(const ::f64_rectangle & rectangleParam, ::draw2d::pen * pdraw2dpen, ::f64 dRadius)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::draw_round_rectangle(rectangleParam, pdraw2dpen, dRadius);
      //if (m_pdraw2dpen.is_set() && m_pdraw2dpen->m_epen != ::draw2d::e_pen_null)
      //{
      ...
      //   auto pdraw2dpen = m_pdraw2dpen.cast <::draw2d_direct2d_for_directx12::pen >();

      //   ID2D1Brush * pd2d1brush = pdraw2dpen->get_os_data < ID2D1Brush * >(this);

      //   defer_primitive_blend();

      //   m_pd2d1rendertarget->DrawRoundedRectangle(rectangle, pd2d1brush, (FLOAT)pdraw2dpen->m_dWidth);
   ...
   void graphics::_draw_raw(const ::f64_rectangle & rectangleTarget, ::image::image * pimageSource, const ::image::image_drawing_options & imagedrawingoptions, const ::f64_point & pointSrc)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::_draw_raw(rectangleTarget, pimageSource, imagedrawingoptions, pointSrc);
   ...
   void graphics::_stretch_raw(const ::f64_rectangle & rectangleTarget, ::image::image * pimage, const ::image::image_drawing_options & imagedrawingoptions, const ::f64_rectangle & rectangleSource)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::_stretch_raw(rectangleTarget, pimage, imagedrawingoptions, rectangleSource);
   //   //try
   //   //{
   ...
   //      ::direct2d_lock direct2dlock(::direct2d::get());
   ...
   ::color::color graphics::GetPixel(::f64 x, ::f64 y)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::GetPixel(x, y);
   ...
   ::color::color graphics::GetPixel(const ::f64_point & point)
   {
      ...
      //return {};
      return ::draw2d_direct2d_for_directx11::graphics::GetPixel(point);
   ...
   ::color::color graphics::SetPixel(::f64 x, ::f64 y, const ::color::color & color)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::SetPixel(x, y, color);
   ...
   ::color::color graphics::SetPixel(const ::f64_point & point, const ::color::color & color)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::SetPixel(point, color);
   ...
   ::u32 graphics::GetTextAlign()
   {
      ...
      //return false;
      return ::draw2d_direct2d_for_directx11::graphics::GetTextAlign();
   ...
   void graphics::get_text_metrics(::write_text::text_metric * pmetrics)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::get_text_metrics(pmetrics);
   ...
   void graphics::get_output_text_metrics(::write_text::text_metric * lpMetrics)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::get_output_text_metrics(lpMetrics);
      //throw ::exception(todo);
   ...
   void graphics::set_smooth_mode(::draw2d::enum_smooth_mode esmoothmode)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::set_smooth_mode(esmoothmode);
   ...
   ::u32 graphics::SetBoundsRect(const ::f64_rectangle & rectangleBounds, ::u32 flags)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::SetBoundsRect(rectangleBounds, flags);
   ...
   ::u32 graphics::GetBoundsRect(::f64_rectangle * prectBounds, ::u32 flags)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::GetBoundsRect(prectBounds, flags);
   ...
   ::i32 graphics::StartPage()
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::StartPage();
   ...
   ::i32 graphics::EndPage()
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::EndPage();
   ...
   ::i32 graphics::AbortDoc()
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::AbortDoc();
   ...
   ::i32 graphics::EndDoc()
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::EndDoc();
   ...
   void graphics::angle_arc(::f64 x, ::f64 y, ::f64 nRadius, f64_angle fStartAngle, f64_angle fSweepAngle)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::angle_arc(x, y, nRadius, fStartAngle, fSweepAngle);
      //throw ::exception(todo);
   ...
   void graphics::poly_polyline(const ::f64_point * ppoints, const ::i32 * lpPolyPoints, ::collection::count nCount)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::poly_polyline(ppoints, lpPolyPoints, nCount);
      //throw ::exception(todo);
   ...
   void graphics::poly_bezier(const ::f64_point * ppoints, ::collection::count nCount)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::poly_bezier(ppoints, nCount);
      //throw ::exception(todo);
   ...
   void graphics::abort_path()
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::abort_path();
   ...
   void graphics::begin_path()
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::begin_path();
   ...
   void graphics::close_figure()
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::close_figure();
   ...
   void graphics::end_path()
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::end_path();
   ...
   void graphics::fill_path()
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::fill_path();
   ...
   void graphics::flatten_path()
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::flatten_path();
   ...
   ::f32 graphics::GetMiterLimit()
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::GetMiterLimit();
   ...
   void graphics::SetMiterLimit(::f32 fMiterLimit)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::SetMiterLimit(fMiterLimit);
   ...
   void graphics::stroke_and_fill_path()
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::stroke_and_fill_path();
   ...
   void graphics::stroke_path()
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::stroke_path();
   ...
   void graphics::widen_path()
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::widen_path();
   ...
   void graphics::AddMetaFileComment(::u32 nDataSize, const ::u8 * pCommentData)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::AddMetaFileComment(nDataSize, pCommentData);
   ...
   //      //dynamic_cast <::draw2d_direct2d_for_directx12::graphics *> (pgraphicsSrc)->SaveClip();
   ...
   //         //dynamic_cast <::draw2d_direct2d_for_directx12::graphics *> (pgraphicsSrc)->RestoreClip();
...
#define HIMETRIC_INCH   2540    // HIMETRIC units per inch
   ...
   {
      ::draw2d_direct2d_for_directx11::graphics::DPtoHIMETRIC(psize);
      //#ifdef WINDOWS_DESKTOP
   ...
   {
      ::draw2d_direct2d_for_directx11::graphics::HIMETRICtoDP(psize);
      //#ifdef WINDOWS_DESKTOP
      //      ASSERT(is_memory_segment_ok(psize, sizeof(::f64_size)));
      //
      //      ::f64 dMapMode;
   ...
   {
      return ::draw2d_direct2d_for_directx11::graphics::GetHalftoneBrush(pparticle);
      /*
   ...
   ::i32 graphics::save_graphics_context()
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::save_graphics_context();
   ...
   void graphics::restore_graphics_context(::i32 iSavedContext)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::restore_graphics_context(iSavedContext);
   ...
   {
      ::draw2d_direct2d_for_directx11::graphics::set_interpolation_mode(einterpolationmode);
...
//   {
   ...
   ::f64_size graphics::set_extents(::f64 x, ::f64 y)
   {
      ...
      //return {};
      return ::draw2d_direct2d_for_directx11::graphics::set_extents(x, y);
   ...
   ::f64_size graphics::scale_extents(::f64 xNum, ::f64 xDenom, ::f64 yNum, ::f64 yDenom)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::scale_extents(xNum, xDenom, yNum, yDenom);
   ...
   ::f64_point graphics::SetWindowOrg(::f64 x, ::f64 y)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::SetWindowOrg(x, y);
   ...
   ::f64_point graphics::offset_window_org(::f64 dWidth, ::f64 dHeight)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::offset_window_org(dWidth, dHeight);
   ...
   ::i32 graphics::get_clip_box(::f64_rectangle & rectangle)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::get_clip_box(rectangle);
      //return 0;
      //throw ::exception(todo);
   ...
   void graphics::reset_clip()
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::reset_clip();
      ////::draw2d::lock draw2dlock;
   ...
   void graphics::_push_layer(const ::i32_rectangle_array_base& rectanglea)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::_push_layer(rectanglea);
   ...
   void graphics::_push_layer(ID2D1Geometry * pgeometry)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::_push_layer(pgeometry);
   ...
   void graphics::_pop_layer()
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::_pop_layer();
   ...
   void graphics::_pop_all_layers()
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::_pop_all_layers();
   ...
   void graphics::_intersect_clip()
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::_intersect_clip();
   ...
   void graphics::_add_shape(const ::f64_rectangle & rectangle)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::_add_shape(rectangle);
   ...
   void graphics::_add_shape(const ::f64_ellipse & ellipse)
   {
      ...
      //throw ::exception(error_not_supported);
      ::draw2d_direct2d_for_directx11::graphics::_add_shape(ellipse);
   ...
   void graphics::_add_shape(const ::f64_polygon_base & polygon)
   {
      ...
      //throw ::exception(error_not_supported);
      ::draw2d_direct2d_for_directx11::graphics::_add_shape(polygon);
   ...
   void graphics::_add_clip_item(::draw2d::clip_item * pclipitem)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::_add_clip_item(pclipitem);
   ...
   void graphics::_add_clip_item(ID2D1GeometrySink * pgeometrysink, ::draw2d::clip_item * pclipitem)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::_add_clip_item(pgeometrysink, pclipitem);
   ...
   void graphics::intersect_clip(const ::f64_rectangle & rectangle)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::intersect_clip(rectangle);
   ...
   ::u32 graphics::SetTextAlign(::u32 nFlags)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::SetTextAlign(nFlags);
   ...
   void graphics::apply_primitive_blend()
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::apply_primitive_blend();
   ...
   void graphics::apply_text_rendering_hint()
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::apply_text_rendering_hint();
      //try
      //{
   ...
   void graphics::defer_text_primitive_blend()
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::defer_text_primitive_blend();
   ...
   ::u32 graphics::GetLayout()
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::GetLayout();
   ...
   ::u32 graphics::SetLayout(::u32 dwSetLayout)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::SetLayout(dwSetLayout);
   ...
   {
      ::draw2d_direct2d_for_directx11::graphics::on_start_layer(pgpulayer);
   ...
   void graphics::on_end_layer(::gpu::layer* pgpulayer)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::on_end_layer(pgpulayer);
      ...
      //   auto hrEndDraw = m_pd2d1devicecontext->EndDraw();

      //   if (FAILED(hrEndDraw))
      //   {

      //      warning() << "Direct2D EndDraw failed in on_end_layer. HRESULT=" << (long long)hrEndDraw;
   ...
   void graphics::polydraw(const ::f64_point * ppoints, const ::u8 * lpTypes, ::collection::count nCount)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::polydraw(ppoints, lpTypes, nCount);
   ...
   void graphics::polyline_to(const ::f64_point * ppoints, ::collection::count nCount)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::polyline_to(ppoints, nCount);
   ...
   void graphics::poly_bezier_to(const ::f64_point * ppoints, ::collection::count nCount)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::poly_bezier_to(ppoints, nCount);
      //throw ::exception(todo);
   ...
   void graphics::SelectClipPath(::i32 nMode)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::SelectClipPath(nMode);
...
//         //(dynamic_cast<::draw2d_direct2d_for_directx12::graphics * >(pdraw2dgraphics))->SetMapMode((::i32)(::i16)pMetaRec->rdParm[0]);
//         break;
//      case META_SETWINDOWEXT:
//         (dynamic_cast<::draw2d_direct2d_for_directx12::graphics *>(pdraw2dgraphics))->set_window_ext(
//         (::i32)(::i16)pMetaRec->rdParm[1], (::i32)(::i16)pMetaRec->rdParm[0]);
//         break;
//      case META_SETWINDOWORG:
//         (dynamic_cast<::draw2d_direct2d_for_directx12::graphics *>(pdraw2dgraphics))->SetWindowOrg(
//         (::i32)(::i16)pMetaRec->rdParm[1], (::i32)(::i16)pMetaRec->rdParm[0]);
//         break;
//      case META_SETVIEWPORTEXT:
//         (dynamic_cast<::draw2d_direct2d_for_directx12::graphics *>(pdraw2dgraphics))->set_extents(
//         (::i32)(::i16)pMetaRec->rdParm[1], (::i32)(::i16)pMetaRec->rdParm[0]);
//         break;
//      case META_SETVIEWPORTORG:
//         (dynamic_cast<::draw2d_direct2d_for_directx12::graphics *>(pdraw2dgraphics))->set_origin(
//         (::i32)(::i16)pMetaRec->rdParm[1], (::i32)(::i16)pMetaRec->rdParm[0]);
//         break;
//      case META_SCALEWINDOWEXT:
//         (dynamic_cast<::draw2d_direct2d_for_directx12::graphics *>(pdraw2dgraphics))->scale_window_ext(
//         (::i32)(::i16)pMetaRec->rdParm[3], (::i32)(::i16)pMetaRec->rdParm[2],
//         (::i32)(::i16)pMetaRec->rdParm[1], (::i32)(::i16)pMetaRec->rdParm[0]);
//         break;
//      case META_SCALEVIEWPORTEXT:
//         (dynamic_cast<::draw2d_direct2d_for_directx12::graphics *>(pdraw2dgraphics))->scale_extents(
//         (::i32)(::i16)pMetaRec->rdParm[3], (::i32)(::i16)pMetaRec->rdParm[2],
//         (::i32)(::i16)pMetaRec->rdParm[1], (::i32)(::i16)pMetaRec->rdParm[0]);
//         break;
//      case META_OFFSETVIEWPORTORG:
//         (dynamic_cast<::draw2d_direct2d_for_directx12::graphics *>(pdraw2dgraphics))->offset_origin(
//         (::i32)(::i16)pMetaRec->rdParm[1], (::i32)(::i16)pMetaRec->rdParm[0]);
//         break;
//      case META_SAVEDC:
//         (dynamic_cast<::draw2d_direct2d_for_directx12::graphics *>(pdraw2dgraphics))->save_graphics_context();
//         break;
//      case META_RESTOREDC:
//         (dynamic_cast<::draw2d_direct2d_for_directx12::graphics *>(pdraw2dgraphics))->restore_graphics_context((::i32)(::i16)pMetaRec->rdParm[0]);
//         break;
...
//
//         (dynamic_cast<::draw2d_direct2d_for_directx12::graphics *>(pdraw2dgraphics))->set(pdraw2dbrush);
//
//      }
//      break;
...
//            //HFONT hFontOld = (HFONT)::SelectObject((dynamic_cast<::draw2d_direct2d_for_directx12::graphics * >(pdraw2dgraphics))->get_handle1(), hStockFont);
//            //HGDIOBJ hObjOld = ::SelectObject((dynamic_cast<::draw2d_direct2d_for_directx12::graphics * >(pdraw2dgraphics))->get_handle1(), hObject);
//            //if (hObjOld == hStockFont)
//            //{
//            //   // got the stock object back, so must be selecting a font
//            //   throw ::not_implemented();
//            //   //                  (dynamic_cast<::draw2d_direct2d_for_directx12::graphics * >(pdraw2dgraphics))->SelectObject(::draw2d_direct2d_for_directx12::font::from_handle_dup(pdraw2dgraphics->get_application(), (HFONT)hObject));
//            //   break;  // don't play the default record
//            //}
//            //else
//            //{
//            //   // didn't get the stock object back, so restore everything
//            //   ::SelectObject((dynamic_cast<::draw2d_direct2d_for_directx12::graphics * >(pdraw2dgraphics))->get_handle1(), hFontOld);
//            //   ::SelectObject((dynamic_cast<::draw2d_direct2d_for_directx12::graphics * >(pdraw2dgraphics))->get_handle1(), hObjOld);
//            //}
...
//#endif
   ...
   void graphics::LPtoDP(::f64_size * psize)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::LPtoDP(psize);
   ...
   void graphics::DPtoLP(::f64_size * psize)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::DPtoLP(psize);
   ...
   void graphics::draw_text(const ::scoped_string & scopedstr, const ::f64_rectangle & rectangle, const ::e_align & ealign, const ::e_draw_text & edrawtext)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::draw_text(scopedstr, rectangle, ealign, edrawtext);
      ...
      //ID2D1Brush * pdraw2dbrush = m_pdraw2dbrush->get_os_data < ID2D1Brush * >(this);
      ...
      //IDWriteTextFormat * pwritetextfont = m_pwritetextfont->get_os_data < IDWriteTextFormat * >(this);
      ...
      //   pwritetextfont->SetTextAlignment(DWRITE_TEXT_ALIGNMENT_TRAILING);

      //}
      //else if (ealign & e_align_horizontal_center)
      //{

      //   pwritetextfont->SetTextAlignment(DWRITE_TEXT_ALIGNMENT_CENTER);

      //}
      //else
      //{

      //   pwritetextfont->SetTextAlignment(DWRITE_TEXT_ALIGNMENT_LEADING);
      ...
      //   pwritetextfont->SetParagraphAlignment(DWRITE_PARAGRAPH_ALIGNMENT_FAR);

      //}
      //else if (ealign & e_align_vertical_center)
      //{

      //   pwritetextfont->SetParagraphAlignment(DWRITE_PARAGRAPH_ALIGNMENT_CENTER);

      //}
      //else
      //{

      //   pwritetextfont->SetParagraphAlignment(DWRITE_PARAGRAPH_ALIGNMENT_NEAR);
      ...
      //   m_pd2d1rendertarget->DrawText(ptextitem->get_text(), (::u32)ptextitem->get_text().length(), pwritetextfont,
      //                                 &rectf, pdraw2dbrush);
   ...
   ::f64_size graphics::_get_text_extent(const ::scoped_string & scopedstr, character_count iIndex)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::_get_text_extent(scopedstr, iIndex);
      ...
      //auto pwritetextfont = m_pwritetextfont->get_os_data < IDWriteTextFormat * >(this);
      ...
      //     pwritetextfont,    // The text format to apply to the string (contains font information, etc).
   ...
   ::f64_size graphics::_get_text_extent(const ::scoped_string & scopedstr)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::_get_text_extent(scopedstr);
   ...
   void graphics::fill_rectangle(const ::f64_rectangle & rectangleParam, const ::color::color & color)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::fill_rectangle(rectangleParam, color);
   ...
   void graphics::set_target_image(::image::image * pimage)
   {
      ...
      ::cast < ::draw2d_direct2d_for_directx12::bitmap > pdraw2dbitmap = pimage->m_pdraw2dbitmap;

      auto & pd2d1bitmap = pdraw2dbitmap->m_pd2d1bitmap;
   ...
   void graphics::text_out(::f64 x, ::f64 y, const ::scoped_string & scopedstr)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::text_out(x, y, scopedstr);
      ...
      //HRESULT  hr = pwritetextfont->SetTextAlignment(DWRITE_TEXT_ALIGNMENT_LEADING);
      ...
      //hr = pwritetextfont->SetParagraphAlignment(DWRITE_PARAGRAPH_ALIGNMENT_NEAR);
      ...
      //hr = pwritetextfont->SetTrimming(&trim, nullptr);
      ...
      //hr = pwritetextfont->SetWordWrapping(DWRITE_WORD_WRAPPING_NO_WRAP);
      ...
      //   m_pd2d1rendertarget->DrawText(lpcwsz, (::i32)uiLen, pwritetextfont, &rectf, pdraw2dbrush);
   ...
   void graphics::line(::f64 x1, ::f64 y1, ::f64 x2, ::f64 y2, ::draw2d::pen * pdraw2dpen)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::line(x1, y1, x2, y2, pdraw2dpen);
      ...
      //ID2D1Brush * pdraw2dbrush = m_pdraw2dpen->get_os_data < ID2D1Brush * >(this);
      ...
      //m_pd2d1rendertarget->DrawLine(p1, p2, pdraw2dbrush, (FLOAT)(dynamic_cast <::draw2d_direct2d_for_directx12::pen *> (m_pdraw2dpen.m_p))->m_dWidth);
   ...
   void graphics::line(::f64 x1, ::f64 y1, ::f64 x2, ::f64 y2)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::line(x1, y1, x2, y2);
      ...
      //FLOAT fWidth = (FLOAT)(dynamic_cast <::draw2d_direct2d_for_directx12::pen *> (m_pdraw2dpen.m_p))->m_dWidth;

      //m_pd2d1rendertarget->DrawLine(p1, p2, pdraw2dbrush, fWidth);
   ...
   void graphics::start_layer(bool bFirstLayer, ::user::interaction * puserinteraction)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::start_layer(bFirstLayer, puserinteraction);
      ...
      //      if (pgpucontext->m_pgpucompositor != this)
      //      {

      //         bind_draw2d_compositor(pgpulayer);

      //         m_bLayerResourceAcquired = true;
      ...
      //      //::cast < ::draw2d_direct2d_for_directx12::image > pimage = m_pimage;
   ...
   void graphics::end_layer(bool bClosingLayer)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::end_layer(bClosingLayer);
      ...
      //      //   m_pd2d1rendertarget->Clear(color);

      //      //}

      //      auto hrEndDraw = m_pd2d1rendertarget->EndDraw();

      //      if (FAILED(hrEndDraw))
      //      {

      //         warning() << "Direct2D EndDraw failed in end_layer. HRESULT=" << (long long)hrEndDraw;
      ...
      //   defer_soft_unbind_draw2d_compositor(::gpu::current_layer());
   ...
   void graphics::set_alpha_mode(::draw2d::enum_alpha_mode ealphamode)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::set_alpha_mode(ealphamode);
   ...
   void graphics::end_draw()
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::end_draw();
      ...
      //      warning() << "Direct2D EndDraw failed in end_draw. HRESULT=" << (long long)hrEndDraw;
...
//   }
   ...
   void graphics::attach(void * pdata)
   {
      ...
      //m_osdata[::draw2d_direct2d::data_device_context] = m_pd2d1devicecontext;
   ...
   void * graphics::detach()
   {
      ...
      //m_osdata[::draw2d_direct2d::data_device_context] = nullptr;
   ...
   void graphics::blur(bool bExpand, ::f64 dRadius, const ::f64_rectangle & rectangle)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::blur(bExpand, dRadius, rectangle);
   ...
   ::f64 graphics::get_dpix()
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::get_dpix();
   ...
   void graphics::destroy()
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::destroy();
      //destroy_os_data();
   ...
   void graphics::clear_current_point()
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::clear_current_point();
   ...
   void graphics::draw(::draw2d::path * pdraw2dpath)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::draw(pdraw2dpath);
   ...
   bool graphics::draw(ID2D1PathGeometry * pgeometry, ::draw2d::pen * pdraw2dpen)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::draw(pgeometry, pdraw2dpen);

      //::ID2D1Brush * pdraw2dbrush = pdraw2dpen->get_os_data < ID2D1Brush * >(this);
      ...
      //::ID2D1StrokeStyle1 * pstrokestyle = pdraw2dpen->get_os_data < ID2D1StrokeStyle1 * >(this, 1);

      //m_pd2d1rendertarget->DrawGeometry(pgeometry, pdraw2dbrush, (FLOAT)pdraw2dpen->m_dWidth, pstrokestyle);
   ...
   bool graphics::fill(ID2D1PathGeometry * pgeometry, ::draw2d::brush * pdraw2dbrush)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::fill(pgeometry, pdraw2dbrush);
   ...
   bool graphics::draw(ID2D1GeometryRealization * prealization, ::draw2d::pen * pdraw2dpen)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::draw(prealization, pdraw2dpen);
      ...
      //m_pd2d1devicecontext1->DrawGeometryRealization(prealization, pdraw2dbrush);
   ...
   bool graphics::fill(ID2D1GeometryRealization * prealization, ::draw2d::brush * pdraw2dbrush)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::fill(prealization, pdraw2dbrush);
   ...
   void graphics::draw(::draw2d::path * ppathParam, ::draw2d::pen * pdraw2dpen)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::draw(ppathParam, pdraw2dpen);
      ...
      //ID2D1PathGeometry * pgeometry = pdraw2dpath->get_os_data < ID2D1PathGeometry * >(this, ::draw2d_direct2d::path_hollow);
      ...
      //      auto prealization = pdraw2dpath->_get_stroked_geometry_realization(this, (::i32)pdraw2dpen->m_dWidth);
   ...
   void graphics::fill(::draw2d::path * pdraw2dpath)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::fill(pdraw2dpath);
   ...
   void graphics::fill(::draw2d::path * ppathParam, ::draw2d::brush * pdraw2dbrush)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::fill(ppathParam, pdraw2dbrush);
      ...
      //ID2D1PathGeometry * pgeometry = pdraw2dpath->get_os_data < ID2D1PathGeometry * >(this, ::draw2d_direct2d::path_filled);
      ...
      //   //m_pd2d1rendertarget->FillGeometry(pgeometry, pdraw2dbrush);
   ...
   void graphics::path(::draw2d::path * pdraw2dpath)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::path(pdraw2dpath);
   ...
   bool graphics::draw(const ::write_text::text_out & textout, ::draw2d::pen * pdraw2dpen)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::draw(textout, pdraw2dpen);
      ...
      //CustomTextRenderer renderer(m_pdirect2d->d2d1_factory1(),m_pd2d1rendertarget,pdraw2dpen->get_os_data < ID2D1Brush * >(this));
   ...
   bool graphics::fill(const ::write_text::text_out & textout, ::draw2d::brush * pdraw2dbrush)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::fill(textout, pdraw2dbrush);
   ...
   bool graphics::draw(const ::write_text::draw_text & drawtext, ::draw2d::pen * pdraw2dpen)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::draw(drawtext, pdraw2dpen);
   ...
   bool graphics::fill(const ::write_text::draw_text & drawtext, ::draw2d::brush * pdraw2dbrush)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::fill(drawtext, pdraw2dbrush);
   ...
   void graphics::flush()
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::flush();
      //if (m_bBeginDraw)
      //{
...
//#endif
      ...
      ::draw2d_direct2d_for_directx11::graphics::debug();
   ...
   //void graphics::set_direct2d_plugin(::draw2d_direct2d_for_directx12::plugin * pplugin)
   //{
