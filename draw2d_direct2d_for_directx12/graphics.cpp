...
namespace draw2d_direct2d_for_directx12
{
   ...
   ::draw2d::bitmap * graphics::get_target_bitmap()
   {
      ...
      ::cast<::draw2d_direct2d_for_directx12::bitmap> pbitmap = m_pbitmapTarget;
   ...
   void graphics::_create_memory_graphics(const ::i32_size & size, ::acme::user::interaction * pacmeuserinteractionAffinity)
   {
      ...
      if (::is_set(m_pacmeuserinteractionAffinity))
      {
         ...
         pacmewindowingwindow = m_pacmeuserinteractionAffinity->m_pacmewindowingwindow;
      ...
      pcontext->sendø() << [this, size]()
         {
            ...
            if (m_pd2d1bitmaprendertarget)
            {
               ...
               hr = m_pd2d1bitmaprendertarget->GetBitmap(&pbitmap);
               if (SUCCEEDED(hr) &&
   ...
   void graphics::set(::draw2d::bitmap * pbitmapParam)
   {
      ...
      //::pointer<::draw2d_direct2d_for_directx12::bitmap>pbitmap = pbitmapParam;
      ...
      //   //::pointer<::draw2d_direct2d_for_directx12::graphics>pgraphics = m_pgraphics;

      //   //::pointer<::draw2d_direct2d_for_directx12::bitmap>pbitmap = m_pbitmap;
...
//
  //    return {};
   ...
   void graphics::frame_rectangle(const ::f64_rectangle & rectangleParam, ::draw2d::brush * pbrush)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::frame_rectangle(rectangleParam, pbrush);
      //if (m_pd2d1rendertarget == nullptr)
      //{
...
//
   ...
   void graphics::draw_rectangle(const ::f64_rectangle & rectangleParam, ::draw2d::pen * ppen)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::draw_rectangle(rectangleParam, ppen);
      ...
      //::draw2d_direct2d_for_directx12::pen * ppen2 = dynamic_cast <::draw2d_direct2d_for_directx12::pen *> (ppen);
   ...
   void graphics::fill_rectangle(const ::f64_rectangle & rectangleParam, ::draw2d::brush * pbrush)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::fill_rectangle(rectangleParam, pbrush);
      //if (pbrush == nullptr)
      //{
      ...
      //::draw2d_direct2d_for_directx12::brush * pbrush2 = dynamic_cast <::draw2d_direct2d_for_directx12::brush *> (pbrush);
   ...
   void graphics::fill_round_rectangle(const ::f64_rectangle & rectangleParam, ::draw2d::brush * pbrush, ::f64 dRadius)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::fill_round_rectangle(rectangleParam, pbrush, dRadius);
      //if (pbrush->m_ebrush == ::draw2d::e_brush_box_gradient)
      //{
      ...
      //   auto pbrush = m_pbrush.cast <::draw2d_direct2d_for_directx12::brush >();
   ...
   void graphics::draw_round_rectangle(const ::f64_rectangle & rectangleParam, ::draw2d::pen * ppen, ::f64 dRadius)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::draw_round_rectangle(rectangleParam, ppen, dRadius);
      ...
      //   auto ppen = m_ppen.cast <::draw2d_direct2d_for_directx12::pen >();
...
//         //(dynamic_cast<::draw2d_direct2d_for_directx12::graphics * >(pgraphics))->SetMapMode((::i32)(::i16)pMetaRec->rdParm[0]);
//         break;
//      case META_SETWINDOWEXT:
//         (dynamic_cast<::draw2d_direct2d_for_directx12::graphics *>(pgraphics))->set_window_ext(
//         (::i32)(::i16)pMetaRec->rdParm[1], (::i32)(::i16)pMetaRec->rdParm[0]);
//         break;
//      case META_SETWINDOWORG:
//         (dynamic_cast<::draw2d_direct2d_for_directx12::graphics *>(pgraphics))->SetWindowOrg(
//         (::i32)(::i16)pMetaRec->rdParm[1], (::i32)(::i16)pMetaRec->rdParm[0]);
//         break;
//      case META_SETVIEWPORTEXT:
//         (dynamic_cast<::draw2d_direct2d_for_directx12::graphics *>(pgraphics))->set_extents(
//         (::i32)(::i16)pMetaRec->rdParm[1], (::i32)(::i16)pMetaRec->rdParm[0]);
//         break;
//      case META_SETVIEWPORTORG:
//         (dynamic_cast<::draw2d_direct2d_for_directx12::graphics *>(pgraphics))->set_origin(
//         (::i32)(::i16)pMetaRec->rdParm[1], (::i32)(::i16)pMetaRec->rdParm[0]);
//         break;
//      case META_SCALEWINDOWEXT:
//         (dynamic_cast<::draw2d_direct2d_for_directx12::graphics *>(pgraphics))->scale_window_ext(
//         (::i32)(::i16)pMetaRec->rdParm[3], (::i32)(::i16)pMetaRec->rdParm[2],
//         (::i32)(::i16)pMetaRec->rdParm[1], (::i32)(::i16)pMetaRec->rdParm[0]);
//         break;
//      case META_SCALEVIEWPORTEXT:
//         (dynamic_cast<::draw2d_direct2d_for_directx12::graphics *>(pgraphics))->scale_extents(
//         (::i32)(::i16)pMetaRec->rdParm[3], (::i32)(::i16)pMetaRec->rdParm[2],
//         (::i32)(::i16)pMetaRec->rdParm[1], (::i32)(::i16)pMetaRec->rdParm[0]);
//         break;
//      case META_OFFSETVIEWPORTORG:
//         (dynamic_cast<::draw2d_direct2d_for_directx12::graphics *>(pgraphics))->offset_origin(
//         (::i32)(::i16)pMetaRec->rdParm[1], (::i32)(::i16)pMetaRec->rdParm[0]);
//         break;
//      case META_SAVEDC:
//         (dynamic_cast<::draw2d_direct2d_for_directx12::graphics *>(pgraphics))->save_graphics_context();
//         break;
//      case META_RESTOREDC:
//         (dynamic_cast<::draw2d_direct2d_for_directx12::graphics *>(pgraphics))->restore_graphics_context((::i32)(::i16)pMetaRec->rdParm[0]);
//         break;
...
//
//         (dynamic_cast<::draw2d_direct2d_for_directx12::graphics *>(pgraphics))->set(pbrush);
//
//      }
//      break;
...
//            //HFONT hFontOld = (HFONT)::SelectObject((dynamic_cast<::draw2d_direct2d_for_directx12::graphics * >(pgraphics))->get_handle1(), hStockFont);
//            //HGDIOBJ hObjOld = ::SelectObject((dynamic_cast<::draw2d_direct2d_for_directx12::graphics * >(pgraphics))->get_handle1(), hObject);
//            //if (hObjOld == hStockFont)
//            //{
//            //   // got the stock object back, so must be selecting a font
//            //   throw ::not_implemented();
//            //   //                  (dynamic_cast<::draw2d_direct2d_for_directx12::graphics * >(pgraphics))->SelectObject(::draw2d_direct2d_for_directx12::font::from_handle_dup(pgraphics->get_application(), (HFONT)hObject));
//            //   break;  // don't play the default record
//            //}
//            //else
//            //{
//            //   // didn't get the stock object back, so restore everything
//            //   ::SelectObject((dynamic_cast<::draw2d_direct2d_for_directx12::graphics * >(pgraphics))->get_handle1(), hFontOld);
//            //   ::SelectObject((dynamic_cast<::draw2d_direct2d_for_directx12::graphics * >(pgraphics))->get_handle1(), hObjOld);
//            //}
...
//#endif
   ...
   void graphics::set_target_image(::image::image * pimage)
   {
      ...
      ::cast < ::draw2d_direct2d_for_directx12::bitmap > pbitmap = pimage->m_pbitmap;

      auto & pd2d1bitmap = pbitmap->m_pd2d1bitmap;
   ...
   void graphics::line(::f64 x1, ::f64 y1, ::f64 x2, ::f64 y2, ::draw2d::pen * ppen)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::line(x1, y1, x2, y2, ppen);
   ...
   void graphics::line(::f64 x1, ::f64 y1, ::f64 x2, ::f64 y2)
   {
      ...
      //FLOAT fWidth = (FLOAT)(dynamic_cast <::draw2d_direct2d_for_directx12::pen *> (m_ppen.m_p))->m_dWidth;
...
//      d3d11Device->QueryInterface(__uuidof(IDXGIDevice), (void**)&dxgiDevice);
   ...
   void graphics::destroy_os_data()
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::destroy_os_data();
   ...
   void graphics::draw(::draw2d::path * ppath)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::draw(ppath);
   ...
   bool graphics::draw(ID2D1PathGeometry * pgeometry, ::draw2d::pen * ppen)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::draw(pgeometry, ppen);
   ...
   bool graphics::fill(ID2D1PathGeometry * pgeometry, ::draw2d::brush * pbrush)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::fill(pgeometry, pbrush);
   ...
   bool graphics::draw(ID2D1GeometryRealization * prealization, ::draw2d::pen * ppen)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::draw(prealization, ppen);
   ...
   bool graphics::fill(ID2D1GeometryRealization * prealization, ::draw2d::brush * pbrush)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::fill(prealization, pbrush);
   ...
   void graphics::draw(::draw2d::path * ppathParam, ::draw2d::pen * ppen)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::draw(ppathParam, ppen);
      ...
      //ID2D1PathGeometry * pgeometry = ppath->get_os_data < ID2D1PathGeometry * >(this, ::draw2d_direct2d::path_hollow);
   ...
   void graphics::fill(::draw2d::path * ppath)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::fill(ppath);
   ...
   void graphics::fill(::draw2d::path * ppathParam, ::draw2d::brush * pbrush)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::fill(ppathParam, pbrush);
      ...
      //ID2D1PathGeometry * pgeometry = ppath->get_os_data < ID2D1PathGeometry * >(this, ::draw2d_direct2d::path_filled);
   ...
   void graphics::path(::draw2d::path * ppath)
   {
      ...
      ::draw2d_direct2d_for_directx11::graphics::path(ppath);
   ...
   bool graphics::draw(const ::write_text::text_out & textout, ::draw2d::pen * ppen)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::draw(textout, ppen);
   ...
   bool graphics::fill(const ::write_text::text_out & textout, ::draw2d::brush * pbrush)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::fill(textout, pbrush);
   ...
   bool graphics::draw(const ::write_text::draw_text & drawtext, ::draw2d::pen * ppen)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::draw(drawtext, ppen);
   ...
   bool graphics::fill(const ::write_text::draw_text & drawtext, ::draw2d::brush * pbrush)
   {
      ...
      return ::draw2d_direct2d_for_directx11::graphics::fill(drawtext, pbrush);
