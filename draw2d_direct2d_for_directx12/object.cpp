...
namespace draw2d_direct2d_for_directx12
{
   ...
   void object::initialize_draw2d_direct2d_object(::draw2d_direct2d_for_directx12::graphics* pgraphics)
   {

      initialize(pgraphics);

      ::cast < ::draw2d_direct2d_for_directx11::graphics > pdraw2direct2dgraphics = pgraphics;
