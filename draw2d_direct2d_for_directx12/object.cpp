...
namespace draw2d_direct2d_for_directx12
{
   ...
   void object::initialize_draw2d_direct2d_object(::draw2d_direct2d_for_directx12::graphics* pdraw2dgraphics)
   {

      initialize(pdraw2dgraphics);

      ::cast < ::draw2d_direct2d_for_directx11::graphics > pdraw2direct2dgraphics = pdraw2dgraphics;

      //::cast < ::draw2d_direct2d_for_directx11::draw2d > pdraw2direct2ddraw2d = pdraw2direct2dgraphics->direct2d();

      ::draw2d_direct2d_for_directx11::object::initialize_draw2d_direct2d_object(pdraw2direct2dgraphics);
