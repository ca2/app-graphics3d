...
#include "draw2d_direct2d_for_directx11/pen.h"
#include "object.h"
...
namespace draw2d_direct2d_for_directx12
{
   ...
   class CLASS_DECL_DRAW2D_DIRECT2D_FOR_DIRECTX12 pen :
      virtual public ::draw2d_direct2d_for_directx12::object,
      virtual public ::draw2d_direct2d_for_directx11::pen
   {
   public:
      ...
      //virtual ID2D1Brush * get_os_pen_brush(::draw2d_direct2d_for_directx12::graphics * pdraw2dgraphics) const;
