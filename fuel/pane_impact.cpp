...
namespace app_core_fuel
{
   ...
   void pane_impact::on_message_create(::message::message * pmessage)
   {
      ...
      set_tab("fuel"_ansi, MAIN_IMPACT);
...
//         {
//
//            m_pimpactLast = dynamic_cast < impact * > (tab_holder(id_index(MAIN_IMPACT))->get_child_by_id("fuel_impact"_ansi));
//
//         }
//         else if (get_impact_id() == MAIN_SWITCHER_IMPACT)
//         {
//
//            m_pimpactLast = dynamic_cast < impact * > (tab_holder(id_index(MAIN_SWITCHER_IMPACT))->get_child_by_id("fuel_impact"_ansi));
//
//         }
//
//
...
//         //try
//         //{
//         //   pform->get_child_by_id("clockverse_auto"_ansi)->set_check(papp->should_auto_launch_clockverse_on_hover(),::e_source_initialize);
//         //}
//         //catch(...)
//         //{
//         //}
...
//         //try
//         //{
//         //   pform->get_child_by_id("flag"_ansi)->set_check(papp->should_bind_flag_country_ca2_domain_image_on_hover(),::e_source_initialize);
//         //}
//         //catch(...)
//         //{
//         //}
...
//         //try
//         //{
//         //   pform->get_child_by_id("flag_auto"_ansi)->set_check(papp->should_auto_launch_flag_on_hover(),::e_source_initialize);
//         //}
//         //catch(...)
//         //{
//         //}
//
   ...
   void pane_impact::handle(::topic * ptopic, ::handler_context * phandlercontext)
   {
      ...
      //      //      {
      //      //         m_prollfps->set_text(""_ansi,::e_source_initialize);
      //      //      }
      //      //      else
      //      //      {
