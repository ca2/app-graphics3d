...
namespace gpu_vulkan
{
   ...
   render_target::render_target()
   {
      ...
      m_bAdvancedPipelineSynchronization = true;
   ...
   //VkImageView render_target::getImageView(int index)
   //{ 
   ...
   //VkImageView render_target::getDepthImageView(int index)
   //{
   ...
   //
   //VkResult render_target::acquireNextImage() 
   //{
   ...
   //VkResult render_target::submitCommandBuffers(
   ...
   //
   ////VkSurfaceFormatKHR render_target::chooseSwapSurfaceFormat(
   ...
   ////VkPresentModeKHR render_target::chooseSwapPresentMode(
   ...
   ////VkExtent2D render_target::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
   ...
   //VkFormat render_target::findDepthFormat() 
   //{
