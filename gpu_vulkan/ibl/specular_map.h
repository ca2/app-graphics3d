// From gpu_opengl/specular_map.h by
// camilo on 2025-09-29 18:35 <3ThomasBorregaardSorensen!!
#pragma once
...
namespace gpu_vulkan
{
   ...
   namespace ibl
   {
       ...
       */
      class CLASS_DECL_GPU_VULKAN specular_map : virtual public ::gpu::ibl::specular_map
      {
      public:
