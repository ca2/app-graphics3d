...
//
//
//   void accumulation_render_pass::initialize_render_pass(::gpu::context* pgpucontext, ::pointer_array < ::gpu::texture >* ptexturea, ::pointer<::gpu_vulkan::render_pass> previous)
//   {
//
//      render_pass::initialize_render_pass(pgpucontext, ptexturea, previous);
//
//   }
//
...
//
//      //::cast < ::gpu_vulkan::context > pgpucontext = pcontext;
//
...
//
//      m_ptexturea->set_size(m_pgpucontext->m_pgpurenderer->m_pgpurendertarget->get_frame_count());
//
...
//      ::cast < ::gpu_vulkan::context > pcontext = m_pgpucontext;
//
//      m_imageviewsAlphaAccumulation.resize(m_ptexturea->size());
//
