...
void context_fbo::on_initialize_particle()
{
   ...
   ::vulkan::context::on_initialize_particle();
   ...
   void context_fbo::_create_offscreen_buffer(const ::int_size & sizeParam)
   {
      ...
      this->post([this, size]()
         ...
         CGLPixelFormatAttribute AttribList[] =
         {
            ...
            //         kCGLPFAVulkanProfile, (CGLPixelFormatAttribute)kCGLOGLPVersion_GL3_Core,
            ...
            //
            //kCGLPFAVulkanProfile, (CGLPixelFormatAttribute)kCGLOGLPVersion_GL4_Core,
            kCGLPFAVulkanProfile, (CGLPixelFormatAttribute)kCGLOGLPVersion_GL3_Core,
            //         kCGLPFAVulkanProfile, (CGLPixelFormatAttribute)kCGLOGLPVersion_GL3_2_Core,
         ...
         //auto displayMask= CGDisplayIDToVulkanDisplayMask (display);
