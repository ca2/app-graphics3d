...
BEGIN_GPU_PROPERTIES(::app_graphics3d_hello_space::point_light)
...
BEGIN_GPU_PROPERTIES(::app_graphics3d_hello_space::global_ubo)
...
GPU_PROPERTY("pointLights", ::gpu_properties<::app_graphics3d_hello_space::point_light>(), MAX_LIGHTS)
