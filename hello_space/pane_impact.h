...
#include "app-graphics3d/continuum/pane_impact.h"
...
namespace app_graphics3d_hello_space
{
   ...
   class CLASS_DECL_APP_GRAPHICS3D_HELLO_SPACE pane_impact :
      virtual public ::app_consumer < application, ::app_graphics3d_continuum::pane_impact >
   {
   public:
