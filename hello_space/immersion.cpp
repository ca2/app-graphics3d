...
namespace app_graphics3d_hello_space
{
   ...
   immersion::immersion()
   {
      ...
      //m_emouse = ::app_graphics3d_hello_space::e_mouse_updateLook;
      //m_ekeyboard = ::app_graphics3d_hello_space::e_keyboard_updateMovement;
   ...
   ::pointer<::graphics3d::scene_base> immersion::create_main_scene()
   {
      ...
      auto pinput = create_newø < ::app_graphics3d_hello_space::input>();
   ...
   //      ::cast<::app_graphics3d_hello_space::camera> pcamera = pcameraScene;
