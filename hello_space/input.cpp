// From mnk_controller from V0idsEmbrace@Twich hello_space project
...
//
//   //   ::cast<::app_graphics3d_hello_space::immersion> pimmersion = m_pgraphics3dengineinstance->m_pimmersionlayer;
//
//
//   //               if (pimmersion->m_emouse == ::app_graphics3d_hello_space::e_mouse_updateLook)
//   //   {
//
...
//
//      ::cast<::app_graphics3d_hello_space::camera> pcamera = pgpucamera;
//
//      if (pcamera)
//      {
//
...
//      
//      ::cast<::app_graphics3d_hello_space::immersion> pimmersion = m_pgraphics3dengineinstance->m_pimmersionlayer;
//      if (pimmersion->m_ekeyboard == ::app_graphics3d_hello_space::e_keyboard_updateMovement)
//      {
//
//         process_keyboard_input_updateMovement();
//      }
//      else if (pimmersion->m_ekeyboard == ::app_graphics3d_hello_space::e_keyboard_spaceExplorer)
//      {
//
//         ::cast<::app_graphics3d_hello_space::immersion> pimmersion = m_pgraphics3dengineinstance->m_pimmersionlayer;
