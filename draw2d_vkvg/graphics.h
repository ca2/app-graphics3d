...
//                  int nWidth, int nHeight, ::draw2d::bitmap& maskBitmap, int xMask, int yMask);
      ...
      virtual void internal_draw_text_vkvg(const block& block, const ::f64_rectangle& f64_rectangle, const ::e_align& ealign = e_align_top_left, const ::e_draw_text& edrawtext = e_draw_text_none, PFN_VKVG_TEXT pfnText = nullptr);
