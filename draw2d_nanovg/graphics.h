...
namespace draw2d_nanovg
{
   ...
   class CLASS_DECL_DRAW2D_NANOVG graphics :
...
//                          int (CALLBACK* lpfn)(LPVOID, LPARAM), LPARAM lpData);
   ...
   public:
      ...
      ::draw2d_nanovg::draw2d * draw2d_nanovg();
...
// #endif
      ...
      // Clipping Functions
      virtual int get_clip_box(f64_rectangle * prectangle) const;
...
//      i32_point MoveTo(int x, int y);
      ...
      void angle_arc(double x, double y, double nRadius,::f64_angle fStartAngle, ::f64_angle fSweepAngle);
      ...
      //void polydraw(const ::f64_point* lpPoints, const unsigned char* lpTypes,::collection::count nCount);
      void polyline_to(const ::f64_point * lpPoints,::collection::count nCount);
      void poly_polyline(const ::f64_point * lpPoints, const int * lpPolyPoints,::collection::count nCount);
...
//      bool DrawState(const ::i32_point & point, const ::i32_size & size, HBITMAP hBitmap, unsigned int nFlags,
//                     HBRUSH hBrush = nullptr);
//      bool DrawState(const ::i32_point & point, const ::i32_size & size, ::draw2d::bitmap* pBitmap, unsigned int nFlags,
//                     ::draw2d::brush* pBrush = nullptr);
//      bool DrawState(const ::i32_point & point, const ::i32_size & size, HICON hIcon, unsigned int nFlags,
//                     HBRUSH hBrush = nullptr);
//      bool DrawState(const ::i32_point & point, const ::i32_size & size, HICON hIcon, unsigned int nFlags,
//                     ::draw2d::brush* pBrush = nullptr);
//      bool DrawState(const ::i32_point & point, const ::i32_size & size, const ::scoped_string & lpszText, unsigned int nFlags,
...
//                     LPARAM lData, unsigned int nFlags, ::draw2d::brush* pBrush = nullptr);
      ...
      void poly_polygon(const f64_point * lpPoints, const int * lpPolyCounts,::collection::count nCount) override;
...
//                  int nWidth, int nHeight, ::draw2d::bitmap& maskBitmap, int xMask, int yMask);
      ...
      //virtual bool ExtTextOut(int x, int y, unsigned int nOptions, const ::i32_rectangle & rectangle, const ::scoped_string & lpszString,character_count nCount, LPINT lpDxWidths);
      //virtual bool ExtTextOut(int x, int y, unsigned int nOptions, const ::i32_rectangle & rectangle, const ::scoped_string & str, LPINT lpDxWidths);
      ...
      virtual void internal_draw_text(const block& block, const ::f64_rectangle& rectangle, const ::e_align& ealign,
         const ::e_draw_text& edrawtext);

      //virtual void internal_draw_text_nanovg(const block& block, const ::f64_rectangle& f64_rectangle, const ::e_align& ealign = e_align_top_left, const ::e_draw_text& edrawtext = e_draw_text_none, PFN_VKVG_TEXT pfnText = nullptr);
      virtual void internal_draw_text_nanovg(const block& block, const ::f64_rectangle& f64_rectangle, const ::e_align& ealign = e_align_top_left, const ::e_draw_text& edrawtext = e_draw_text_none);
      ...
      //void draw_text_ex(const ::string & str, const ::f64_rectangle & prectd, const ::e_align & ealign = e_align_top_left, const ::e_draw_text & edrawtext = e_draw_text_none) override;
...
//      // Advanced Drawing
//      bool DrawEdge(const ::i32_rectangle & rectangle,unsigned int nEdge,unsigned int nFlags);
//      bool DrawFrameControl(const ::i32_rectangle & rectangle,unsigned int nType,unsigned int nState);
      ...
      bool _set(const ::f64_arc& arc, const ::pointer<::draw2d::region>& pregion);
      //bool _set(const ::line & line);
      //bool _set(const ::lines & lines);
      bool _set(const ::f64_rectangle& rectangle, const ::pointer<::draw2d::region>& pregion);
      bool _set(const ::f64_ellipse& ellipse, const ::pointer<::draw2d::region>& pregion);
      bool _set(const ::f64_polygon& polygon, const ::pointer<::draw2d::region>& pregion);
      ...
      bool _set(const ::f64_line& line);
      bool _set(const ::f64_lines& lines);
      bool _set(const ::f64_rectangle& rectangle);
      bool _set(const ::f64_ellipse& ellipse);
      bool _set(const ::f64_polygon& polygon);
...
//      virtual bool attach(void * pdata);
      ...
      void _vk_rectangle(const ::f64_rectangle & rectangle);

   };


   CLASS_DECL_DRAW2D_NANOVG graphics * thread_graphics();

   CLASS_DECL_DRAW2D_NANOVG void thread_graphics(graphics * graphics);
