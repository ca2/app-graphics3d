...
namespace draw2d_nanovg
{
   ...
   class CLASS_DECL_DRAW2D_NANOVG bitmap : 
...
//
      ...
      void create_bitmap(::draw2d::graphics * pgraphics, const ::i32_size& size, ::image32_t ** ppimage32, const ::image32_t *pimage32,  int* piScan) override;
