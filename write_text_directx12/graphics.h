...
//      i32_point move_to(double x, double y) override;
      ...
      virtual bool ExtTextOut(double x, double y, UINT nOptions, const f64_rectangle &  prectangle, const ::scoped_string & scopedstrString,character_count nCount, LPINT lpDxWidths) override;

      virtual bool ExtTextOut(double x, double y, UINT nOptions, const f64_rectangle &  prectangle, const ::scoped_string & scopedstr, LPINT lpDxWidths) override;

      virtual f64_size TabbedTextOut(double x, double y, const ::scoped_string & scopedstrString, character_count nCount,count nTabPositions, LPINT lpnTabStopPositions, int nTabOrigin) override;

      virtual f64_size TabbedTextOut(double x, double y, const ::scoped_string & scopedstr,count nTabPositions, LPINT pnTabStopPositions, int nTabOrigin) override;
...
//
//      int Escape(int nEscape, int nInputSize,  const_char_pointer pszInputData,int nOutputSize, char * pszOutputData) override;
//
