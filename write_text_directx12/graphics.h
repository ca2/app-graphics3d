...
//      int_point move_to(double x, double y) override;
      ...
      virtual bool ExtTextOut(double x, double y, UINT nOptions, const double_rectangle &  prectangle, const ::scoped_string & scopedstrString,character_count nCount, LPINT lpDxWidths) override;
      ...
      virtual double_size TabbedTextOut(double x, double y, const ::scoped_string & scopedstrString, character_count nCount,count nTabPositions, LPINT lpnTabStopPositions, int nTabOrigin) override;
      ...
      //virtual bool draw_text_ex(const ::scoped_string & scopedstrString,character_count nCount,const ::double_rectangle & rectangle, const ::e_align & ealign = e_align_top_left, const ::e_draw_text & edrawtext = e_draw_text_none,LPDRAWTEXTPARAMS lpDTParams) override;
      ...
      virtual double_size GetTextBegin(const ::scoped_string & scopedstrString, character_count nCount, character_count iIndex) override;
      ...
      virtual double_size GetTabbedTextExtent(const ::scoped_string & scopedstrString, character_count nCount,count nTabPositions, LPINT lpnTabStopPositions) override;
      ...
      virtual double_size GetOutputTabbedTextExtent(const ::scoped_string & scopedstrString, character_count nCount,count nTabPositions, LPINT lpnTabStopPositions) override;
