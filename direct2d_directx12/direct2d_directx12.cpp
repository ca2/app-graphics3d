...
namespace direct2d_directx12
{
   ...
   class direct2d_directx12* direct2d_directx12::s_pdirect2d = nullptr;


   direct2d_directx12::direct2d_directx12()
   {
   ...
   void direct2d_directx12::initialize(::particle * pparticle)
   {
   ...
   comptr<ID2D1Device> direct2d_directx12::create_device(::windowing::window* pwindow, const ::int_rectangle& rectanglePlacement)
   {
   ...
   IDWriteFactory * direct2d_directx12::dwrite_factory(bool bCreate)
   {
   ...
   ID2D1Factory1 * direct2d_directx12::d2d1_factory1(bool bCreate)
   {
   ...
   ID2D1Device * direct2d_directx12::d2d1_device(::windowing::window* pwindow, const ::int_rectangle& rectanglePlacement)
   {
   ...
   ID2D1DeviceContext* direct2d_directx12::default_d2d1_device_context(::windowing::window* pwindow, const ::int_rectangle& rectanglePlacement)
   {
   ...
   comptr<ID2D1DeviceContext> direct2d_directx12::create_d2d1_device_context(::windowing::window* pwindow, const ::int_rectangle& rectanglePlacement)
   {
   ...
   ID2D1DeviceContext* direct2d_directx12::default_d2d1_device_context()
   {
   ...
   comptr < ID2D1PathGeometry1 > direct2d_directx12::create_rectangle_path_geometry(const ::double_rectangle & rectangle)
   {
   ...
   CLASS_DECL_DIRECT2D_DIRECTX12 void defer_initialize(::windowing::window* pwindow, const ::int_rectangle& rectanglePlacement)
   {

      if (::is_set(direct2d_directx12::s_pdirect2d))
      {
      ...
      ___new class direct2d_directx12;

      direct2d_directx12::s_pdirect2d->initialize(pwindow);

      //direct2d_directx12::s_pdirect2d->initialize_direct2d(pwindow, rectanglePlacement);

   }


   CLASS_DECL_DIRECT2D_DIRECTX12 void finalize()
   {

      ::acme::del(direct2d_directx12::s_pdirect2d);
...
direct2d_directx12_lock::direct2d_directx12_lock()
{

   auto pdirect2d = ::direct2d_directx12::get();
...
direct2d_directx12_lock::~direct2d_directx12_lock()
{
   ...
   if (m_bLocked)
   {
      ...
      ::direct2d_directx12::direct2d_directx12::s_pdirect2d->m_pd2d1multithread->Leave();
