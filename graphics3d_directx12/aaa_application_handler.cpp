...
namespace graphics3d_directx12 
{
   ...
   //   pdirectx12example->initialize_application(pcontainer);

   //   pdirectx12example->m_pmousestate = pmousestate;
   //   //pdirectx12example->initDirectX12();

   //   // DirectX12Example->setupWindow(::GetModuleHandleW(L"app_graphics3d_vulken.dll"_ansi), WndProc);
   //   //pdirectx12example->prepare();
   //   //   pdirectx12example->renderLoop20(callback);
   //      //delete(DirectX12Example);
   //   return pdirectx12example;
   //}
   ...
   void application_handler::run_application()
   {
      ...
      //::pointer < directx12_land_continuum::application> papp = m_p3dapplication;
      ...
      ////m_pcontext = __allocate context(m_pdirectx12device);
