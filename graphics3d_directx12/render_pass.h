...
//
//
//   class CLASS_DECL_GRAPHICS3D_DIRECTX12 render_pass :
...
//
//      render_pass(::gpu::context * pgpucontextRef, VkExtent2D windowExtent);
//      render_pass(::gpu::context * pgpucontextRef, VkExtent2D windowExtent, ::pointer <render_pass>previous);
//      ~render_pass();
//
