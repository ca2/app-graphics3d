...
//
//
//   render_pass::render_pass(::gpu::context * pgpucontextRef, VkExtent2D extent)
//      : m_pgpucontext(pgpucontextRef), windowExtent(extent)
//   {
//      //init();
...
//
//   
//   render_pass::render_pass(::gpu::context * pgpucontextRef, VkExtent2D extent, ::pointer<render_pass> previous)
//      : m_pgpucontext{ pgpucontextRef }, windowExtent{ extent }, m_pvkcrenderpassOld{ previous } 
//   {
//      //init();
...
//
//   
//   HRESULT render_pass::acquireNextImage(uint32_t* imageIndex) 
//   {
//
//      //vkWaitForFences(
...
//
//
//   HRESULT render_pass::submitCommandBuffers(
