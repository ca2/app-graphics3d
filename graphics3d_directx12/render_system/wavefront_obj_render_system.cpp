...
#include "gpu/ibl/hlsl/wavefront.vert.h"
#include "gpu/ibl/hlsl/wavefront.frag.h"
...
//      };
      ...
      return ::as_memory_block(g_psz_wavefront_vert);
...
//      };
      ...
      return ::as_memory_block(g_psz_wavefront_frag);
