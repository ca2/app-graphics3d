// From graphics3d_directx11/texture_render_system by 
//    camilo on 2026-09-10 09:51 <3ThomasBorregaardSørensen!! Mummi!! bilbo!!
// From graphics3d_vulkan/texture_render_system by 
//    camilo on 2026-09-10 12:50 <3ThomasBorregaardSørensen!! Mummi!! bilbo!!
// From graphics3d_opengl/texture_render_system by 
//    camilo on 2026-08-15 09:04 <3ThomasBorregaardSørensen!! Mummi!! bilbo!!
...
#include "gpu/hlsl/texture.vert.h"
#include "gpu/hlsl/texture.frag.h"
...
namespace graphics3d_directx12
{
                                                               ...
                                                               ::graphics3d::scene_renderable *pscenerenderable)
   {
      ...
      //auto T =
      //   ::floating_matrix4::translation(
      //      pscenerenderable->m_sequence3Translation);

      //auto R =
      //   pscenerenderable->m_matrixRotation;

      //auto S =
      //   ::floating_matrix4::scaling(
      //      s);

      ////
      //// With shader convention:
      ////
      ...
      //auto matrixModel3 =
      //   ::floating_matrix3(matrixModel);

      //auto determinant =
      //   matrixModel3.determinant();

      //if (::std::abs(determinant) <= FLT_EPSILON)
      //{
      //   ::information(
      //      "model ({}) normal matrix determinant near zero: {}",
      //      pscenerenderable->m_strName,
      //      determinant);

      //   //
      //   // Cannot compute inverse-transpose.
      //   //
      //   // Choose whatever fallback is appropriate for ca2.
      //   //
      //   matrixNormal = ::floating_matrix4();

      //   return;
      //}

      //auto matrixNormal3 =
      //   matrixModel3.inversed().transposed();

      //matrixNormal = matrixNormal3;
auto T = ::floating_matrix4::translation(pscenerenderable->m_sequence3Translation);
...
matrixNormal = n;
   ...
   ::memory texture_render_system::vert_shader_memory()
   {
      ...
      return ::as_memory_block(g_psz_texture_vert);
   ...
   ::memory texture_render_system::frag_shader_memory()
   {
      ...
      return ::as_memory_block(g_psz_texture_frag);
