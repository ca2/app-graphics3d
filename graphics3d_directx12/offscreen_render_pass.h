...
//{
//
//	class CLASS_DECL_GRAPHICS3D_DIRECTX12 offscreen_render_pass :
...
//
//		offscreen_render_pass(::gpu::context * pgpucontextRef, VkExtent2D windowExtent);
//		offscreen_render_pass(::gpu::context * pgpucontextRef, VkExtent2D windowExtent, ::pointer <render_pass>previous);
...
//
//		HRESULT acquireNextImage(uint32_t* imageIndex) override;
//		HRESULT submitCommandBuffers(const VkCommandBuffer* buffers, uint32_t* imageIndex);
//
