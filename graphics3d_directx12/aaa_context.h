...
////#include "window.h"
////#include "directx12-graphics3d/graphics3d_directx12/context.h"
...
//
//
//   class CLASS_DECL_GRAPHICS3D_DIRECTX12 context :
...
//      //context(::graphics3d_directx12::DirectX12Device * pdevice);
//      context();
//      ~context();
//
...
//
//      // helper functions
//      bool isDeviceSuitable(VkPhysicalDevice pgpucontext);
//      ::array<const char*> getRequiredExtensions();
//      bool checkValidationLayerSupport();
//      QueueFamilyIndices findQueueFamilies(VkPhysicalDevice pgpucontext);
//      void populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo);
//      void hasGflwRequiredInstanceExtensions();
//      bool checkDeviceExtensionSupport(VkPhysicalDevice pgpucontext);
//      SwapChainSupportDetails querySwapChainSupport(VkPhysicalDevice pgpucontext);
//
//   };
//
//
